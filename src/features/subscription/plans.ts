...
export const PLANS: SubscriptionPlan[] = [
  ...
  { id: 'master', name: 'Master Student', price: 20, description: 'The complete Historify experience.', color: 'border-amber-400',
    features: ['Everything in Pro Learner', 'AI Essay Challenge (exclusive)', 'Video Review Challenge (exclusive)', 'AI Tutor – 300 messages/month', 'Downloadable lesson notes', 'Advanced analytics & skills radar', 'Historical Chess Ranks (Video XP)', 'Priority support', 'Master badge on profile'],
