...
export const PLANS: SubscriptionPlan[] = [
  { id: 'free', name: 'Free', price: 0, description: 'Start your history journey.', color: 'border-border',
    features: ['1 lesson per era (5 total)', 'Basic quiz (score only)', 'Timeline – major events only', 'Basic progress tracking', 'Leaderboard access', 'Clio AI Tutor – 5 messages/day'],
  ...
  { id: 'pro', name: 'Pro Student', price: 9.99, description: 'Unlock the full curriculum.', badge: 'Most Popular', color: 'border-primary',
    features: ['Everything in Beginner', 'All lessons across 5 eras', 'AI Tutor – 50 messages/month', 'Smart Quiz (adaptive AI)', 'Study Plan – weekly learning path', 'AI Content Studio – study kits from any text', 'Personal notes & bookmarks', 'Progress analytics & leaderboard', 'Debate a Philosopher (resets every 12 hours)', 'Territory Map – interactive historical borders & markers'],
