...
export const PLANS: SubscriptionPlan[] = [
  { id: 'free', name: 'Free', price: 0, description: 'Start your history journey.', color: 'border-border',
    features: ['1 lesson per era (6 total)', 'Basic quiz (score only)', 'Timeline – major events only', 'Basic progress tracking', 'Leaderboard access', 'Clio AI Tutor – 5 messages/day'],
  ...
  { id: 'master', name: 'Master Student', price: 16.99, description: 'The complete Historify experience.', color: 'border-amber-400',
    features: ['Everything in Pro Student', 'The Atlas - the map you uncover by reading (exclusive)', 'Chronos Crisis Room (exclusive)', 'AI Essay Challenge (exclusive)', 'Video Review Challenge (exclusive)', 'Conquest Campaign – animated battles, all four eras + Legendary Mode (2× XP)', 'Study Plan – "Enhance with Clio" coaching', 'AI Tutor – 100 messages/month', 'Downloadable lesson notes', 'Advanced analytics & skills radar', 'Historical Chess Ranks (Video XP)', 'Master badge on profile'],
