...
export const PLANS: SubscriptionPlan[] = [
  ...
  { id: 'pro', name: 'Pro Learner', price: 10, description: 'Unlock the full curriculum.', badge: 'Most Popular', color: 'border-primary',
    features: ['All 14 lessons across 4 eras', 'Full quizzes with explanations', 'AI Tutor – 50 messages/month', 'Full timeline with filters', 'XP, achievements & streaks', 'Progress analytics'],
