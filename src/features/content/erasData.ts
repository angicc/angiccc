...
export const ERAS: Era[] = [
  ...
  { id: 'byzantine', name: 'The Byzantine World', shortName: 'Byzantium', dateRange: '330 – 1453 CE', description: 'The thousand-year Roman Empire of the East. From Constantine\'s New Rome to the fall of Constantinople: Justinian\'s laws, Hagia Sophia, Greek fire, the alphabet of Cyril and Methodius, and the rise of Orthodox Christianity that shaped half of Europe.', icon: 'church', color: 'text-violet-400', bgGradient: 'from-violet-950/30 to-background', lessonIds: ['byzantine-01','byzantine-02','byzantine-03','byzantine-04','byzantine-05','byzantine-06','byzantine-07','byzantine-08','byzantine-09'], quizId: 'quiz-byzantine' },
  { id: 'middle-ages', name: 'Middle Ages', shortName: 'Medieval', dateRange: '~500 – 1500 CE', description: 'A millennium of knights, cathedrals, plagues, and crusades. Discover how the medieval world shaped modern Europe, the rise of Islam, and the preservation of ancient knowledge.', icon: 'castle', color: 'text-blue-400', bgGradient: 'from-blue-950/30 to-background', lessonIds: ['medieval-01','medieval-02','medieval-03','medieval-04','medieval-05','medieval-06','medieval-07','medieval-08','medieval-09'], quizId: 'quiz-medieval' },
