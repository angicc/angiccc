...
export const QUIZ_TRANS_DEFR: Record<string, Partial<Record<DeFr, QuizQuestionTranslation>>> = {
  ...
  'aq6': {
    de: { question: "Welcher persische König erließ den „Kyros-Zylinder“, der als frühe Erklärung der Menschenrechte gilt?", options: ["Dareios I., der Organisator", "Xerxes, Eroberer Griechenlands", "Kyros der Große", "Artaxerxes, der Langhändige"], explanation: "Kyros der Große befreite die jüdischen Verbannten aus Babylon und erlaubte den unterworfenen Völkern, ihre eigenen Religionen auszuüben." },
    fr: { question: "Quel roi perse promulgua le « cylindre de Cyrus », considéré comme une déclaration précoce des droits humains ?", options: ["Darius Iᵉʳ, l’organisateur", "Xerxès, envahisseur de la Grèce", "Cyrus le Grand", "Artaxerxès à la longue main"], explanation: "Cyrus le Grand libéra les exilés juifs de Babylone et permit aux peuples conquis de pratiquer leurs propres religions." },
  },
  'aq7': {
    de: { question: "Die Seidenstraße erleichterte vor allem den Handel zwischen welchen beiden Zivilisationen?", options: ["Ägypten und die griechischen Stadtstaaten", "Rom und die indische Küste", "China und den Mittelmeerraum", "Persien und den ägyptischen Nil"], explanation: "Die Seidenstraße verband das Han-China mit der Mittelmeerwelt und beförderte Seide, Gewürze und Ideen in beide Richtungen." },
    fr: { question: "La route de la soie facilitait surtout le commerce entre quelles deux civilisations ?", options: ["L’Égypte et les cités grecques", "Rome et la côte indienne", "La Chine et la Méditerranée", "La Perse et le Nil égyptien"], explanation: "La route de la soie reliait la Chine des Han au monde méditerranéen, transportant soie, épices et idées dans les deux sens." },
  },
  'aq8': {
  ...
  'aq10': {
    de: { question: "Worin lag die Bedeutung des Codex Hammurapi (~1754 v. Chr.)?", options: ["Erste demokratische Verfassung", "Erstes schriftliches Gesetzbuch", "Erstes internationales Handelsabkommen", "Erster monotheistischer religiöser Text"], explanation: "Der Codex Hammurapi ist eines der frühesten und vollständigsten schriftlichen Gesetzbücher und umfasst Verbrechen, Handel und gesellschaftliche Beziehungen." },
  ...
  'aq12': {
    de: { question: "Das römische Mailänder Edikt (313 n. Chr.), von Kaiser Konstantin erlassen, war bedeutend, weil es …", options: ["das Christentum zur Staatsreligion machte", "das Christentum im ganzen Reich legalisierte", "alle nichtchristlichen Bürger aus Rom vertrieb", "das Amt des Papstes in Rom schuf"], explanation: "Das Mailänder Edikt erklärte die religiöse Duldung aller Glaubensrichtungen und legalisierte insbesondere das Christentum. Erst 380 n. Chr. unter Theodosius wurde das Christentum zur Staatsreligion." },
    fr: { question: "L’édit de Milan (313 apr. J.-C.), promulgué par l’empereur Constantin, fut important parce qu’il…", options: ["fit du christianisme la religion d’État", "légalisa le christianisme dans tout l’Empire", "expulsa tous les citoyens non chrétiens de Rome", "créa la fonction de pape à Rome"], explanation: "L’édit de Milan proclama la tolérance religieuse pour toutes les fois, légalisant en particulier le christianisme. Ce n’est qu’en 380 apr. J.-C., sous Théodose, que le christianisme devint religion d’État." },
  },
  'aq13': {
    ...
    fr: { question: "Quelle merveille antique, culminant à plus de 130 mètres, resta près de 4 000 ans la plus haute structure édifiée par l’homme ?", options: ["Le colosse de Rhodes, en bronze", "Le phare d’Alexandrie, sur Pharos", "La grande pyramide de Gizeh", "Le temple d’Artémis à Éphèse"], explanation: "La grande pyramide de Khéops à Gizeh (~2560 av. J.-C.) détint le record de plus haute structure du monde jusqu’à ce que la cathédrale de Lincoln la dépasse en 1311 apr. J.-C. — près de 3 800 ans plus tard." },
  },
  'aq14': {
  ...
  'aq18': {
    ...
    fr: { question: "La pierre de Rosette fut cruciale pour les historiens parce qu’elle permit de déchiffrer quoi ?", options: ["Le cunéiforme des Sumériens", "Le linéaire A minoen", "Les hiéroglyphes égyptiens", "L’alphabet phénicien"], explanation: "Son même texte en hiéroglyphes, en démotique et en grec permit à Champollion de percer les hiéroglyphes en 1822." },
  },
  'aq19': {
  ...
  'aq22': {
    de: { question: "Was war eine Satrapie im Persischen Reich?", options: ["Ein religiöses Fest des Reiches", "Eine Provinzstatthalterschaft", "Eine Einheit der Leibreiterei", "Ein königlicher Palast in Persepolis"], explanation: "Dareios I. teilte das Reich in etwa zwanzig Satrapien, Provinzen unter Statthaltern, die Satrapen genannt wurden." },
    fr: { question: "Qu’était une satrapie dans l’Empire perse ?", options: ["Une fête religieuse de l’empire", "Un gouvernorat provincial", "Une unité de cavalerie royale", "Un palais royal à Persépolis"], explanation: "Darius Iᵉʳ divisa l’empire en une vingtaine de satrapies, des provinces dirigées par des gouverneurs appelés satrapes." },
  },
  'aq23': {
  ...
  'aq28': {
    de: { question: "Die Bibliothek von Alexandria war Teil welcher größeren Gelehrteneinrichtung?", options: ["Die Akademie Platons", "Das Lykeion des Aristoteles", "Das Museum (Mouseion)", "Die Stoa des Zenon"], explanation: "Das Mouseion, eine den Musen geweihte Forschungseinrichtung, beherbergte die Bibliothek und besoldete Gelehrte." },
    fr: { question: "La bibliothèque d’Alexandrie faisait partie de quelle institution savante plus vaste ?", options: ["L’Académie de Platon", "Le Lycée d’Aristote", "Le Musée (Mouseîon)", "Le Portique de Zénon"], explanation: "Le Mouseîon, institution de recherche consacrée aux Muses, abritait la bibliothèque et rémunérait des savants." },
  },
  'aq29': {
  ...
  'aq34': {
    de: { question: "Wer besiegte Hannibal 202 v. Chr. bei Zama und beendete damit den Zweiten Punischen Krieg?", options: ["Scipio Africanus", "Fabius Maximus, der Zauderer", "Marius, Reformer der Legionen", "Pompeius, Eroberer des Ostens"], explanation: "Publius Cornelius Scipio trug den Krieg nach Afrika und erwarb sich für den Sieg den Ehrennamen „Africanus“." },
    fr: { question: "Qui défit Hannibal à Zama en 202 av. J.-C., mettant fin à la deuxième guerre punique ?", options: ["Scipion l’Africain", "Fabius Maximus le Temporisateur", "Marius, réformateur des légions", "Pompée, conquérant de l’Orient"], explanation: "Publius Cornelius Scipion porta la guerre en Afrique et gagna le surnom d’« Africain » pour cette victoire." },
  },
  'aq35': {
  ...
  'aq40': {
    de: { question: "Welche Stadt machte Konstantin 330 n. Chr. zur neuen Hauptstadt des Römischen Reiches?", options: ["Ravenna an der Adriaküste", "Antiochia am Fluss Orontes", "Alexandria im Nildelta", "Byzanz (Konstantinopel)"], explanation: "Konstantin gründete die griechische Stadt Byzanz als Konstantinopel neu, das „Neue Rom“ am Bosporus." },
    fr: { question: "Quelle ville Constantin fit-il de la nouvelle capitale de l’Empire romain en 330 apr. J.-C. ?", options: ["Ravenne, sur la côte adriatique", "Antioche, sur l’Oronte", "Alexandrie, dans le delta du Nil", "Byzance (Constantinople)"], explanation: "Constantin refonda la cité grecque de Byzance sous le nom de Constantinople, la « Nouvelle Rome » sur le Bosphore." },
  },
  'aq41': {
    de: { question: "Das babylonische Zahlensystem zur Basis 60 überlebt heute als Ursprung welcher zwei alltäglichen Maße?", options: ["Der 24-Stunden-Tag und die 7-Tage-Woche", "Die 60-Minuten-Stunde und der 360-Grad-Kreis", "Dezimalzahlen zur Basis 10 und das Prozentzeichen", "Der 12-Monats-Kalender und die zwölf Tierkreiszeichen"], explanation: "Die mesopotamische Mathematik war sexagesimal (Basis 60) — der Ursprung unserer 60-Minuten-Stunde und des 360-Grad-Kreises, wie die Lektion anmerkt." },
    fr: { question: "Le système numérique babylonien en base 60 survit aujourd’hui comme origine de quelles deux mesures quotidiennes ?", options: ["Le jour de 24 heures et la semaine de 7 jours", "L’heure de 60 minutes et le cercle de 360 degrés", "Les décimales en base 10 et le signe de pourcentage", "Le calendrier de 12 mois et les douze signes du zodiaque"], explanation: "Les mathématiques mésopotamiennes étaient sexagésimales (base 60) — l’origine de notre heure de 60 minutes et du cercle de 360 degrés, comme le note la leçon." },
  },
  'aq42': {
    de: { question: "Warum gilt der ägyptische Edwin-Smith-Papyrus (~1600 v. Chr.) als so bemerkenswert?", options: ["Er ist die älteste vollständige Karte des menschlichen Körpers", "Es verknüpft Hirnverletzungen mit bestimmten Lähmungen", "Er ist ein rein magisches Zauberbuch ohne medizinischen Wert", "Er beschreibt die erste erfolgreiche Herztransplantation"], explanation: "Der Papyrus dokumentiert chirurgische Behandlungen mit klinischer Beobachtung und erkennt, dass Hirnverletzungen bestimmte Lähmungen hervorrufen — erstaunlich modern für seine Zeit." },
    fr: { question: "Pourquoi le papyrus égyptien Edwin Smith (v. 1600 av. J.-C.) est-il jugé si remarquable ?", options: ["C’est la plus ancienne carte complète du corps humain", "Il relie les lésions cérébrales à des paralysies précises", "C’est un grimoire purement magique sans valeur médicale", "Il décrit la première greffe de cœur réussie"], explanation: "Le papyrus documente des traitements chirurgicaux par observation clinique, reconnaissant que les lésions cérébrales produisent des paralysies précises — étonnamment moderne pour son époque." },
  },
  'aq43': {
    de: { question: "Die Säulen des Parthenon wölben sich in der Mitte leicht nach außen (eine Verfeinerung namens Entasis). Zu welchem Zweck?", options: ["Um gesammeltes Regenwasser in den hohlen Säulen zu speichern", "Um die optische Täuschung des Durchhängens zu korrigieren", "Um das auf dem Dach lastende Gewicht zu verringern", "Um Rillen für Bemalung zu lassen"], explanation: "Die leichte Schwellung wirkt der Neigung des Auges entgegen, hohe gerade Säulen als konkav zu sehen, und erzeugt den Eindruck makelloser Geradheit." },
    fr: { question: "Les colonnes du Parthénon se renflent subtilement au milieu (un raffinement appelé entasis). Dans quel but ?", options: ["Pour stocker l’eau de pluie dans les colonnes creuses", "Pour corriger l’illusion d’optique d’affaissement", "Pour réduire le poids reposant sur le toit", "Pour laisser des cannelures destinées au décor peint"], explanation: "Le léger renflement contrecarre la tendance de l’œil à voir concaves de hautes colonnes droites, créant l’impression d’une rectitude parfaite." },
  },
  'aq44': {
    de: { question: "Der Mechanismus von Antikythera, aus einem antiken Schiffswrack geborgen, zeigt, wie fortgeschritten die hellenistische Technik war. Was war er?", options: ["Eine römische Katapult zum Brechen von Stadtmauern", "Ein Bronzegerät zur Vorhersage von Finsternissen", "Ein phönizischer Kompass für die Fahrt auf hoher See", "Eine ägyptische Wasseruhr für die Tempelriten"], explanation: "Er war ein bronzener Zahnrad-„Computer“ zur Vorhersage von Finsternissen und Himmelspositionen — eine Technik, die jahrhundertelang nicht mehr erreicht wurde." },
    fr: { question: "La machine d’Anticythère, récupérée d’une épave antique, révèle combien l’ingénierie hellénistique était avancée. Qu’était-ce ?", options: ["Une catapulte romaine pour abattre les remparts", "Un dispositif de bronze pour prédire les éclipses", "Une boussole phénicienne pour naviguer en haute mer", "Une clepsydre égyptienne pour rythmer les rites"], explanation: "C’était un « ordinateur » de bronze à engrenages pour prédire éclipses et positions célestes — une ingénierie inégalée pendant bien des siècles." },
  },
  'aq45': {
    de: { question: "Das römische Recht wurde 529 n. Chr. in einer Sammlung systematisiert, die noch heute den Rechtssystemen Europas und Lateinamerikas zugrunde liegt. Welche ist es?", options: ["Die Zwölftafelgesetze des frühen Rom", "Das Mailänder Edikt zur Religion", "Justinians Corpus Juris Civilis", "Die Verfassung der Athener des Solon"], explanation: "Kaiser Justinians Corpus Juris Civilis (529 n. Chr.) kodifizierte das römische Recht; die Zwölftafelgesetze waren Roms weit früheres erstes Gesetzeswerk." },
    fr: { question: "Le droit romain fut systématisé en 529 apr. J.-C. dans une compilation qui sous-tend encore les systèmes juridiques d’Europe et d’Amérique latine. Laquelle ?", options: ["Les Douze Tables de la Rome primitive", "L’Édit de Milan sur la religion", "Le Corpus Juris Civilis de Justinien", "La Constitution d’Athènes de Solon"], explanation: "Le Corpus Juris Civilis de l’empereur Justinien (529 apr. J.-C.) codifia le droit romain ; les Douze Tables étaient le tout premier code de lois de Rome, bien antérieur." },
  },
  'aq46': {
  ...
  'aq50': {
    de: { question: "Das persische Elitekorps, das die Griechen die „Unsterblichen“ nannten, trug diesen Namen aus welchem Grund?", options: ["Sie trugen eine vergoldete Rüstung, die im Kampf als unbesiegbar galt", "Ihre Stärke wurde stets bei genau 10.000 gehalten", "Man hielt sie für auferstandene Priester", "Sie hatten geschworen, in der Schlacht nie zurückzuweichen"], explanation: "Das Korps wurde bei genau 10.000 Mann gehalten; jeder Verlust wurde sofort ersetzt, sodass seine Zahl nie zu sinken schien — daher „Unsterbliche“." },
    fr: { question: "Le corps d’élite perse que les Grecs appelaient les « Immortels » doit ce nom à quelle raison ?", options: ["Ils portaient une armure dorée réputée invincible au combat", "Leur effectif était toujours maintenu à exactement 10 000", "On les croyait des prêtres ressuscités", "Ils avaient juré de ne jamais reculer au combat"], explanation: "Le corps était maintenu à exactement 10 000 hommes ; toute perte était aussitôt comblée, si bien que son effectif ne semblait jamais diminuer — d’où « Immortels »." },
  },
  'mq1': {
  ...
  'mq3': {
    de: { question: "Das Feudalsystem gliederte die Gesellschaft vor allem um welche Beziehung?", options: ["Handel und Gewerbe in den Städten", "Landbesitz und Kriegsdienst", "Kirchliche Autorität und Mönchsgelübde", "Stammesverwandtschaft und Blutrache"], explanation: "Der Feudalismus beruhte darauf, dass Lehnsherren Land (Lehen) an Vasallen im Austausch gegen Kriegsdienst und Treue vergaben." },
    fr: { question: "Le système féodal organisait la société principalement autour de quelle relation ?", options: ["Le commerce et l’artisanat des villes", "La propriété foncière et le service militaire", "L’autorité de l’Église et les vœux monastiques", "La parenté tribale et la vendetta"], explanation: "La féodalité reposait sur des seigneurs octroyant des terres (fiefs) à des vassaux en échange du service militaire et de la fidélité." },
  },
  'mq4': {
  ...
  'mq5': {
    de: { question: "Saladin, der 1187 Jerusalem zurückeroberte, war Sultan welcher Region?", options: ["Persien und das iranische Hochland", "Türkei und die anatolische Küste", "Ägypten und Syrien", "Bagdad und Mesopotamien"], explanation: "Saladin war der kurdische Begründer der Ayyubiden-Dynastie, Herrscher über Ägypten und Syrien. Seine Ritterlichkeit wurde selbst von Kreuzfahrern geachtet." },
    fr: { question: "Saladin, qui reprit Jérusalem en 1187, était sultan de quelle région ?", options: ["La Perse et le plateau iranien", "La Turquie et la côte anatolienne", "Égypte et Syrie", "Bagdad et la Mésopotamie"], explanation: "Saladin était le fondateur kurde de la dynastie ayyoubide, maître de l’Égypte et de la Syrie. Sa chevalerie était respectée même des croisés." },
  },
  'mq6': {
    de: { question: "Der Schwarze Tod tötete schätzungsweise welchen Anteil der Bevölkerung Europas zwischen 1347 und 1353?", options: ["Ein Zehntel der Bevölkerung", "Ein Viertel der Bevölkerung", "Ein Drittel bis die Hälfte", "Zwei Drittel der Bevölkerung"], explanation: "Die Schätzungen reichen von 30–60 % der Bevölkerung Europas. Manche Städte wie Florenz verloren über die Hälfte ihrer Einwohner." },
    fr: { question: "La peste noire aurait tué quelle fraction de la population de l’Europe entre 1347 et 1353 ?", options: ["Un dixième de la population", "Un quart de la population", "Un tiers à la moitié", "Deux tiers de la population"], explanation: "Les estimations vont de 30 à 60 % de la population de l’Europe. Certaines villes, comme Florence, perdirent plus de la moitié de leurs habitants." },
  },
  'mq7': {
    ...
    fr: { question: "Quel document anglais (1215) établit que le roi était soumis à l’autorité de la loi ?", options: ["Le Domesday Book de Guillaume le Conquérant", "La Grande Charte (Magna Carta)", "Le Bill of Rights anglais", "Le Code de la common law"], explanation: "La Magna Carta (« Grande Charte ») fut imposée au roi Jean par des barons révoltés, établissant que même le roi doit se soumettre à la loi." },
  },
  'mq8': {
  ...
  'mq11': {
    de: { question: "Das Große Schisma von 1054 spaltete das Christentum dauerhaft in welche zwei Hauptzweige?", options: ["die katholische und die anglikanische Kirche", "die katholische und die lutherische Kirche", "die römisch-katholische und die orthodoxe", "die koptische und die römisch-katholische"], explanation: "Das Große Schisma spaltete die christliche Kirche in die römisch-katholische Kirche (unter dem Papst in Rom) und die orthodoxe Kirche (unter dem Patriarchen von Konstantinopel) — eine Trennung, die bis heute besteht." },
    fr: { question: "Le grand schisme de 1054 divisa définitivement le christianisme en quelles deux grandes branches ?", options: ["les Églises catholique et anglicane", "les Églises catholique et luthérienne", "catholique romaine et orthodoxe", "les Églises copte et catholique romaine"], explanation: "Le grand schisme scinda l’Église chrétienne en Église catholique romaine (sous le pape à Rome) et Église orthodoxe (sous le patriarche de Constantinople) — une division qui persiste aujourd’hui." },
  },
  'mq12': {
    de: { question: "Thomas von Aquins „Summa Theologica“ (1265–1274) war ein bahnbrechender Versuch, welche zwei geistigen Traditionen zu versöhnen?", options: ["Christliche Theologie und platonische Philosophie", "Christliche Theologie und aristotelische Philosophie", "Islamische Philosophie und christliche Mystiktheologie", "Antikes römisches Recht und christliche Ethik"], explanation: "Aquin verband aristotelische Logik und Philosophie mit der christlichen Lehre und argumentierte, Glaube und Vernunft seien einander ergänzend statt widersprüchlich — ein Grundlagentext der Scholastik." },
    fr: { question: "La « Somme théologique » de Thomas d’Aquin (1265–1274) fut une tentative marquante de concilier quelles deux traditions intellectuelles ?", options: ["Théologie chrétienne et philosophie platonicienne", "Théologie chrétienne et philosophie aristotélicienne", "Philosophie islamique et théologie mystique chrétienne", "Droit romain antique et éthique chrétienne"], explanation: "Thomas d’Aquin fondit la logique et la philosophie aristotéliciennes avec la doctrine chrétienne, soutenant que la foi et la raison étaient complémentaires plutôt que contradictoires — un texte fondateur de la scolastique." },
  },
  'mq13': {
    de: { question: "Welche mittelalterliche technische Entwicklung veränderte die Burgenkriegsführung grundlegend, indem sie dicke Steinmauern weit weniger verteidigungsfähig machte?", options: ["Der Langbogen der englischen Bogenschützen", "Die Armbrust in Söldnerhand", "Schießpulverartillerie und Kanone", "Griechisches Feuer aus Siphonen"], explanation: "Kanonenfeuer konnte Steinmauern durchbrechen, die Heeren jahrhundertelang standgehalten hatten. Im 15. Jahrhundert machte die Schießpulverartillerie die traditionellen mittelalterlichen Befestigungen überflüssig und verwandelte die Militärarchitektur." },
    fr: { question: "Quel progrès technique médiéval transforma fondamentalement la guerre de siège en rendant les épaisses murailles de pierre bien moins défendables ?", options: ["L’arc long des archers anglais", "L’arbalète aux mains des mercenaires", "L’artillerie à poudre et le canon", "Le feu grégeois lancé au siphon"], explanation: "Le tir au canon pouvait percer des murailles de pierre qui avaient résisté aux armées pendant des siècles. Au XVᵉ siècle, l’artillerie à poudre rendit obsolètes les fortifications médiévales traditionnelles, transformant l’architecture militaire." },
  },
  'mq14': {
  ...
  'mq20': {
    de: { question: "Das Umayyaden-Kalifat von Córdoba war im 10. Jahrhundert berühmt für …", options: ["die Zerstörung des klassischen Wissens des römischen Westens", "seine Bibliotheken, Gelehrsamkeit und Koexistenz", "die Abschottung Iberiens vom Mittelmeerhandel", "die Eroberung Frankreichs jenseits der Pyrenäen"], explanation: "Córdoba gehörte zu den größten Städten Europas, mit riesigen Bibliotheken und einer Kultur der Convivencia zwischen den Glaubensrichtungen." },
    fr: { question: "Le califat omeyyade de Cordoue était renommé au Xᵉ siècle pour…", options: ["la destruction du savoir classique de l’Occident romain", "ses bibliothèques, son érudition, sa coexistence", "l’isolement de l’Ibérie du commerce méditerranéen", "la conquête de la France au-delà des Pyrénées"], explanation: "Cordoue comptait parmi les plus grandes villes d’Europe, avec de vastes bibliothèques et une culture de convivencia entre les fois." },
  },
  'mq21': {
  ...
  'mq23': {
    de: { question: "Die Übersetzerbewegung von Toledo war historisch bedeutsam, weil sie …", options: ["die ganze Bibel ins volkssprachliche Spanisch übersetzte", "arabisches und griechisches Wissen ins Lateinische übertrug", "die kastilische Rechtschreibung vereinheitlichte", "das westgotische Recht bewahrte"], explanation: "Mehrsprachige Teams im zurückeroberten Toledo übersetzten Aristoteles, Avicenna und arabische Mathematik und speisten damit Europas Universitäten." },
    fr: { question: "Le mouvement de traduction de Tolède fut historiquement important parce qu’il…", options: ["traduisit la Bible entière en espagnol vernaculaire", "transposa en latin le savoir arabe et grec", "normalisa l’orthographe castillane", "préserva le droit wisigoth"], explanation: "Des équipes multilingues dans la Tolède reconquise traduisirent Aristote, Avicenne et les mathématiques arabes, alimentant les universités d’Europe." },
  },
  'mq24': {
  ...
  'mq26': {
    de: { question: "Welches Schicksal ereilte Jeanne d’Arc 1431?", options: ["Sie fiel in der Schlacht", "Sie wurde im Namen des Königs zur Regentin Frankreichs gekrönt", "Sie wurde nach einem Prozess verbrannt", "Sie zog sich in ein Kloster zurück"], explanation: "Gefangen genommen und an die Engländer verkauft, wurde Jeanne in Rouen wegen Ketzerei verurteilt; ein postumer Wiederaufnahmeprozess sprach sie 1456 frei." },
    fr: { question: "Quel sort connut Jeanne d’Arc en 1431 ?", options: ["Elle mourut au combat", "Elle fut couronnée régente de France au nom du roi", "Elle fut brûlée vive après un procès", "Elle se retira dans un couvent"], explanation: "Capturée et vendue aux Anglais, Jeanne fut condamnée pour hérésie à Rouen ; un procès en révision posthume la réhabilita en 1456." },
  },
  'mq27': {
  ...
  'mq28': {
    de: { question: "Das Domesday Book, 1086 verfasst, war …", options: ["eine religiöse Chronik der normannischen Kirche", "eine Erfassung des englischen Grundbesitzes zur Besteuerung", "ein Kodex der Ritterlichkeit für die Ritter des ganzen Königreichs", "eine Karte normannischer Burgen und Garnisonsstädte"], explanation: "Wilhelms I. große Erhebung verzeichnete, wer welches Land besaß und was es wert war — für Historiker von unschätzbarem Wert." },
    fr: { question: "Le Domesday Book, compilé en 1086, était…", options: ["une chronique religieuse de l’Église normande", "un recensement des propriétés foncières anglaises", "un code de chevalerie pour les chevaliers du roi", "une carte des châteaux et villes de garnison normands"], explanation: "Le grand recensement de Guillaume Iᵉʳ nota qui possédait quelle terre et sa valeur — inestimable pour les historiens." },
  },
  'mq29': {
  ...
  'mq31': {
    de: { question: "Das Haus der Weisheit in Bagdad war vor allem ein Zentrum für …", options: ["militärische Ausbildung für die Garde des Kalifen", "Übersetzung und wissenschaftliche Gelehrsamkeit", "religiöse Wallfahrt", "Seidenproduktion"], explanation: "Unter den Abbasiden versammelte es griechische, persische und indische Texte; Gelehrte wie al-Chwarizmi wirkten dort." },
    fr: { question: "La Maison de la sagesse de Bagdad était surtout un centre de…", options: ["formation militaire pour la garde du calife", "traduction et de recherche scientifique", "pèlerinage religieux", "production de soie"], explanation: "Sous les Abbassides, elle rassembla des textes grecs, perses et indiens ; des savants comme al-Khwarizmi y travaillèrent." },
  },
  'mq32': {
  ...
  'mq36': {
    de: { question: "Der Schwarze Tod erreichte Europa 1347 an Bord von Schiffen, die aus welcher Region eintrafen?", options: ["dem Schwarzmeerhafen Caffa", "dem Nildelta-Hafen Alexandria", "dem Malabarhafen Calicut an Indiens Küste", "dem Atlantikhafen Salé in Marokko"], explanation: "Genueser Galeeren, die vor der Belagerung von Kaffa auf der Krim flohen, trugen pestverseuchte Ratten nach Sizilien." },
    fr: { question: "La peste noire atteignit l’Europe en 1347 à bord de navires arrivant de quelle région ?", options: ["le port de Caffa, sur la mer Noire", "le port d’Alexandrie, dans le delta du Nil", "le port de Calicut, sur la côte de Malabar", "le port atlantique de Salé, au Maroc"], explanation: "Des galères génoises fuyant le siège de Caffa en Crimée transportèrent en Sicile des rats infectés par la peste." },
  },
  'mq37': {
    de: { question: "Eine wichtige wirtschaftliche Folge des Schwarzen Todes in Westeuropa war …", options: ["fallende Löhne für die überlebenden Arbeitskräfte", "ein Anstieg der Leibeigenschaft und deutlich härtere Frondienste", "steigende Löhne und größere Verhandlungsmacht der Bauern", "das Ende der Handelsmessen und des Fernhandels"], explanation: "Der Arbeitskräftemangel ließ die Überlebenden bessere Bedingungen fordern und lockerte im Westen den Griff der Leibeigenschaft." },
    fr: { question: "Un effet économique majeur de la peste noire en Europe occidentale fut…", options: ["la baisse des salaires pour la main-d’œuvre survivante", "un essor du servage et des corvées alourdies", "la hausse des salaires et le pouvoir des paysans", "la fin des foires et du commerce à longue distance"], explanation: "La pénurie de main-d’œuvre permit aux survivants d’exiger de meilleures conditions, desserrant l’étreinte du servage en Occident." },
  },
  'mq38': {
  ...
  'mq39': {
    de: { question: "Die „göttlichen Winde“ (Kamikaze), die Japan 1274 und 1281 retteten, zerstörten Invasionsflotten, die von wem entsandt wurden?", options: ["Den Schatzflotten des Ming-Reiches China", "Dem Königreich Goryeo in Korea", "Den Mongolen unter Kublai Khan", "Der Song-Dynastie Südchinas"], explanation: "Taifune zerschmetterten beide mongolischen Flotten und festigten die Legende vom göttlichen Schutz." },
    fr: { question: "Les « vents divins » (kamikaze) qui sauvèrent le Japon en 1274 et 1281 détruisirent des flottes d’invasion envoyées par…", options: ["Les flottes au trésor de la Chine des Ming", "Le royaume de Goryeo en Corée", "Les Mongols sous Kubilai Khan", "La dynastie Song du sud de la Chine"], explanation: "Des typhons anéantirent les deux armadas mongoles, ancrant la légende d’une protection divine." },
  },
  'mq40': {
  ...
  'mq47': {
    de: { question: "Die beiden mongolischen Invasionen Japans (1274 und 1281) wurden teils durch gewaltige Taifune abgewehrt, die die Japaner … nannten.", options: ["Bushidō", "Kamikaze", "Seppuku", "Sakoku"], explanation: "Ein Taifun — der „göttliche Wind“, Kamikaze — zerschlug die riesige mongolische Flotte von 1281, eine Errettung, die für die japanische Identität zentral wurde." },
    fr: { question: "Les deux invasions mongoles du Japon (1274 et 1281) furent repoussées en partie par de grands typhons que les Japonais appelaient…", options: ["Bushidō", "Kamikaze", "Seppuku", "Sakoku"], explanation: "Un typhon — le « vent divin », kamikaze — anéantit l’immense flotte mongole de 1281, un salut devenu central pour l’identité japonaise." },
  },
  'mq48': {
  ...
  'eq1': {
    de: { question: "Johannes Gutenbergs Erfindung des Buchdrucks mit beweglichen Lettern (~1440) ermöglichte am unmittelbarsten welches Ereignis?", options: ["Die Kreuzzüge in das Heilige Land", "Die protestantische Reformation", "Der Schwarze Tod in ganz Europa", "Die Mongoleneinfälle in die Rus"], explanation: "Die Druckerpresse machte es möglich, Luthers Ideen binnen Wochen in ganz Deutschland zu verbreiten — ohne sie wäre die Reformation vielleicht wie frühere Reformbewegungen unterdrückt worden." },
    fr: { question: "L’invention par Johannes Gutenberg de l’imprimerie à caractères mobiles (v. 1440) rendit le plus directement possible quel événement ?", options: ["Les croisades en Terre sainte", "La Réforme protestante", "La peste noire dans toute l’Europe", "Les invasions mongoles en Rus’"], explanation: "L’imprimerie permit de répandre les idées de Luther à travers l’Allemagne en quelques semaines — sans elle, la Réforme aurait pu être étouffée comme les mouvements réformateurs antérieurs." },
  },
  'eq2': {
    de: { question: "Kolumbus’ erste Landung 1492 erfolgte in welcher Region?", options: ["Brasilien an der Atlantikküste", "Florida und seine Golfküste", "Die Karibik", "Mexiko und sein Hochland"], explanation: "Kolumbus landete auf den Bahamas in der Karibik, im Glauben, Asien erreicht zu haben. Er erkannte nie, dass er einen den Europäern zuvor unbekannten Kontinent gefunden hatte." },
    fr: { question: "Le premier débarquement de Colomb, en 1492, eut lieu dans quelle région ?", options: ["Le Brésil, sur la côte atlantique", "La Floride et sa côte du Golfe", "Les Caraïbes", "Le Mexique et ses hauts plateaux"], explanation: "Colomb accosta aux Bahamas, dans les Caraïbes, croyant avoir atteint l’Asie. Il ne comprit jamais qu’il avait trouvé un continent jusque-là inconnu des Européens." },
  },
  'eq3': {
    de: { question: "Der „Kolumbische Austausch“ bezeichnet welches Phänomen?", options: ["Kolumbus tauschte Gold gegen Gewürze in Indien", "Der Austausch von Pflanzen, Tieren und Seuchen", "Ein Handelsabkommen zwischen Spanien und Portugal", "Kolumbus tauschte Karten mit indigenen Völkern"], explanation: "Der Kolumbische Austausch brachte Pferde, Rinder und tödliche Krankheiten nach Amerika; zurück kehrten Kartoffeln, Tomaten und Mais nach Europa — was beide Hemisphären verwandelte." },
    fr: { question: "L’« échange colombien » désigne quel phénomène ?", options: ["Colomb échangeant de l’or contre des épices", "Le transfert de plantes, d’animaux et de maladies", "Un accord commercial entre l’Espagne et le Portugal", "Colomb échangeant des cartes avec les autochtones"], explanation: "L’échange colombien apporta chevaux, bovins et maladies mortelles aux Amériques ; il rapporta pommes de terre, tomates et maïs à l’Europe — transformant les deux hémisphères." },
  },
  'eq4': {
  ...
  'eq5': {
    de: { question: "Der Westfälische Friede (1648) begründete welches Kernprinzip der modernen internationalen Ordnung?", options: ["Freihandel zwischen allen europäischen Nationen", "Die Vorherrschaft des Papstes über die Fürsten", "Nationale Souveränität und Nichteinmischung", "Die Rechte religiöser Minderheiten überall"], explanation: "Westfalen legte fest, dass Herrscher die Religion ihrer Gebiete bestimmen durften und äußere Mächte sich nicht einmischen sollten — die Grundlage des modernen Nationalstaatensystems." },
    fr: { question: "Les traités de Westphalie (1648) établirent quel principe clé de l’ordre international moderne ?", options: ["Le libre-échange entre toutes les nations européennes", "La suprématie du pape sur les princes", "La souveraineté nationale et la non-ingérence", "Les droits des minorités religieuses partout"], explanation: "La Westphalie établit que les souverains pouvaient déterminer la religion de leurs territoires et que les puissances extérieures ne devaient pas s’y ingérer — le fondement du système moderne des États-nations." },
  },
  'eq6': {
  ...
  'eq8': {
    de: { question: "Der Dreißigjährige Krieg (1618–1648) begann als Konflikt worüber?", options: ["Kolonialgebiete in den Amerikas", "Handelswege in der Ostsee", "Die Religion im Heiligen Römischen Reich", "Die Nachfolge auf dem französischen Thron"], explanation: "Er begann als Glaubenskrieg zwischen Katholiken und Protestanten in Böhmen (dem heutigen Tschechien), ehe er zu einem gesamteuropäischen Machtkonflikt wurde." },
    fr: { question: "La guerre de Trente Ans (1618–1648) débuta comme un conflit à propos de quoi ?", options: ["Un territoire colonial dans les Amériques", "Des routes commerciales en mer Baltique", "La religion dans le Saint-Empire", "La succession au trône de France"], explanation: "Elle commença comme une guerre de religion entre catholiques et protestants en Bohême (l’actuelle Tchéquie) avant de devenir un conflit de puissances européen général." },
  },
  'eq9': {
    de: { question: "Welcher Denker der Aufklärung verfasste „Der Gesellschaftsvertrag“ (1762) mit dem Argument, die Legitimität der Regierung komme vom Volk?", options: ["François-Marie Arouet, genannt Voltaire", "Charles-Louis de Secondat, Montesquieu", "John Locke, der englische Arzt", "Jean-Jacques Rousseau"], explanation: "Rousseaus Gesellschaftsvertrag argumentierte, dass legitime Regierung aus der Zustimmung des Volkes erwächst — ein unmittelbarer Einfluss auf die Amerikanische wie die Französische Revolution." },
    fr: { question: "Quel penseur des Lumières écrivit « Du contrat social » (1762), affirmant que la légitimité du gouvernement vient du peuple ?", options: ["François-Marie Arouet, dit Voltaire", "Charles-Louis de Secondat, Montesquieu", "John Locke, le médecin anglais", "Jean-Jacques Rousseau"], explanation: "Le Contrat social de Rousseau soutenait qu’un gouvernement légitime dérive du consentement populaire — une influence directe sur les révolutions américaine et française." },
  },
  'eq10': {
  ...
  'eq14': {
    de: { question: "John Lockes „Zwei Abhandlungen über die Regierung“ (1689) beeinflussten unmittelbar welches amerikanische Gründungsdokument?", options: ["Die Federalist Papers über die Union", "Die Verfassung der Vereinigten Staaten", "Die Unabhängigkeitserklärung", "Die Bill of Rights und ihre Zusätze"], explanation: "Jeffersons Erklärung schöpft fast wörtlich aus Lockes Konzept der natürlichen Rechte auf „Leben, Freiheit und Eigentum“ (Jefferson ersetzte „Eigentum“ durch „Streben nach Glück“) und dem Recht, eine tyrannische Regierung zu stürzen." },
    fr: { question: "Les « Deux traités du gouvernement civil » de John Locke (1689) influencèrent directement quel document fondateur américain ?", options: ["Le Fédéraliste, sur l’union", "La Constitution des États-Unis", "La Déclaration d’indépendance", "La Déclaration des droits et ses amendements"], explanation: "La Déclaration de Jefferson reprend presque mot pour mot le concept lockéen des droits naturels à « la vie, la liberté et la propriété » (Jefferson remplaça « propriété » par « recherche du bonheur ») et le droit de renverser un gouvernement tyrannique." },
  },
  'eq15': {
    de: { question: "Die „wissenschaftliche Revolution“ soll mit Kopernikus’ heliozentrischer Theorie (1543) begonnen und mit welcher Veröffentlichung gegipfelt haben?", options: ["Galileis Dialog über die Weltsysteme (1632)", "Newtons Principia Mathematica (1687)", "Darwins Entstehung der Arten (1859)", "Keplers Astronomia Nova (1609)"], explanation: "Historiker datieren die wissenschaftliche Revolution herkömmlich von Kopernikus’ heliozentrischem Modell (1543) bis zu Newtons Principia (1687), die ein Jahrhundert von Entdeckungen zu einem einheitlichen mathematischen Naturverständnis zusammenfügten." },
    fr: { question: "La « révolution scientifique » aurait débuté avec la théorie héliocentrique de Copernic (1543) et culminé avec quelle publication ?", options: ["Le Dialogue sur les deux systèmes de Galilée (1632)", "Les Principia Mathematica de Newton (1687)", "L’Origine des espèces de Darwin (1859)", "L’Astronomia Nova de Kepler (1609)"], explanation: "Les historiens datent conventionnellement la révolution scientifique du modèle héliocentrique de Copernic (1543) aux Principia de Newton (1687), qui fondirent un siècle de découvertes en un cadre mathématique unifié de compréhension de la nature." },
  },
  'eq16': {
  ...
  'eq17': {
    de: { question: "Brunelleschis ingenieurtechnisches Meisterwerk in Florenz war …", options: ["Der Petersdom im Vatikan", "Die Kuppel des Florentiner Doms", "Die Uffizien-Galerien in Florenz", "Der Ponte Vecchio über den Arno"], explanation: "Seine doppelschalige Kuppel (1436 vollendet) war die größte je errichtete Mauerwerkskuppel — ohne Gerüst vom Boden aus." },
    fr: { question: "Le chef-d’œuvre d’ingénierie de Brunelleschi à Florence était…", options: ["La basilique Saint-Pierre de Rome au Vatican", "Le dôme de la cathédrale de Florence", "Les galeries des Offices à Florence", "Le Ponte Vecchio sur l’Arno"], explanation: "Son dôme à double coque (achevé en 1436) fut le plus grand dôme de maçonnerie jamais construit — sans échafaudage depuis le sol." },
  },
  'eq18': {
  ...
  'eq20': {
    de: { question: "Hernán Cortés eroberte 1519–1521 welches Reich?", options: ["Die Inka von Peru", "Die Maya von Yucatán", "Die Azteken (Mexica)", "Die Olmeken am Golf von Mexiko"], explanation: "Mit Stahl, Pferden, Pocken und einheimischen Verbündeten stürzte Cortés Tenochtitlan und den Mexica-Staat." },
    fr: { question: "Hernán Cortés conquit quel empire en 1519–1521 ?", options: ["Les Incas du Pérou", "Les Mayas du Yucatán", "Les Aztèques (Mexicas)", "Les Olmèques du golfe du Mexique"], explanation: "Avec l’acier, les chevaux, la variole et des alliés autochtones, Cortés renversa Tenochtitlan et l’État mexica." },
  },
  'eq21': {
  ...
  'eq22': {
    de: { question: "Der Augsburger Religionsfriede (1555) begründete welches Prinzip im Heiligen Römischen Reich?", options: ["Freie Religionsausübung für jeden einzelnen Untertan", "Cuius regio, eius religio — der Glaube des Herrschers", "Päpstliche Vorherrschaft über jeden deutschen Fürsten", "Abschaffung der Klöster im gesamten Reich"], explanation: "Jeder Fürst wählte für seine Lande Luthertum oder Katholizismus; Andersgläubige durften auswandern." },
    fr: { question: "La paix d’Augsbourg (1555) établit quel principe dans le Saint-Empire ?", options: ["La liberté de culte pour chaque sujet individuel", "Cuius regio, eius religio — la foi du souverain", "La suprématie papale sur chaque prince allemand", "L’abolition des monastères dans tout l’empire"], explanation: "Chaque prince choisissait le luthéranisme ou le catholicisme pour ses terres ; les dissidents pouvaient émigrer." },
  },
  'eq23': {
  ...
  'eq24': {
    de: { question: "Heinrich VIII. brach vor allem deshalb mit Rom, weil der Papst sich weigerte, …", options: ["ihn in Rom zum Kaiser des Heiligen Römischen Reiches zu krönen", "seine Ehe mit Katharina von Aragón zu annullieren", "seine Kriege gegen Frankreich und Schottland zu finanzieren", "einen englischen Heiligen seiner Wahl zu kanonisieren"], explanation: "Die Suprematsakte (1534) machte Heinrich zum Oberhaupt der Kirche von England, nachdem die Annullierung verweigert worden war." },
    fr: { question: "Henri VIII rompit avec Rome surtout parce que le pape refusa de…", options: ["le couronner empereur du Saint-Empire à Rome", "annuler son mariage avec Catherine d’Aragon", "financer ses guerres contre la France et l’Écosse", "canoniser un saint anglais de son choix"], explanation: "L’Acte de suprématie (1534) fit d’Henri le chef de l’Église d’Angleterre après le refus de l’annulation." },
  },
  'eq25': {
  ...
  'eq26': {
    de: { question: "Welcher osmanische Sultan belagerte 1529 auf dem Höhepunkt der osmanischen Macht Wien?", options: ["Mehmed II., der Eroberer Konstantinopels", "Selim I., der Grimmige", "Süleyman der Prächtige", "Bayezid II., der Gerechte"], explanation: "Süleymans Heere erreichten Wiens Mauern; Wetter und Nachschub erzwangen den Rückzug." },
    fr: { question: "Quel sultan ottoman assiégea Vienne en 1529, à l’apogée de la puissance ottomane ?", options: ["Mehmed II, le Conquérant de Constantinople", "Sélim Iᵉʳ le Terrible", "Soliman le Magnifique", "Bayezid II le Juste"], explanation: "Les armées de Soliman atteignirent les murs de Vienne ; le temps et la logistique imposèrent le repli." },
  },
  'eq27': {
    de: { question: "Das Devschirme-System versorgte den osmanischen Staat mit …", options: ["Schiffbauholz aus den Wäldern des Balkans", "christlichen Knaben, erzogen als Janitscharen", "Seideneinnahmen aus dem Handel von Bursa", "Getreidetribut aus dem Nildelta"], explanation: "Ausgehobene Knaben traten zum Islam über und stiegen nach Verdienst auf — manche wurden Großwesire." },
    fr: { question: "Le système du devchirmé fournissait à l’État ottoman…", options: ["du bois de marine des forêts des Balkans", "des garçons chrétiens élevés en janissaires", "des revenus de la soie du commerce de Bursa", "un tribut en grain du delta du Nil"], explanation: "Les garçons prélevés se convertissaient à l’islam et s’élevaient au mérite — certains devinrent grands vizirs." },
  },
  'eq28': {
  ...
  'eq30': {
    de: { question: "Der Taj Mahal wurde von Shah Jahan errichtet als …", options: ["ein Siegesmonument für seine Feldzüge", "eine Moschee für die Gläubigen von Delhi", "ein Grabmal für seine Frau Mumtaz Mahal", "ein Palast für seinen ältesten Sohn"], explanation: "Das Mausoleum aus weißem Marmor in Agra (um 1648 vollendet) gedenkt Mumtaz Mahals, die im Kindbett starb." },
    fr: { question: "Le Taj Mahal fut édifié par Shah Jahan comme…", options: ["un monument de victoire pour ses campagnes", "une mosquée pour le peuple de Delhi", "un tombeau pour son épouse Mumtaz Mahal", "un palais pour son fils aîné"], explanation: "Le mausolée de marbre blanc d’Agra (achevé v. 1648) commémore Mumtaz Mahal, morte en couches." },
  },
  'eq31': {
  ...
  'eq32': {
    de: { question: "Japans Sakoku-Politik unter dem Tokugawa-Shogunat bedeutete …", options: ["verpflichtende Samurai-Bildung in den Domänenschulen", "die nahezu vollständige Abschließung nach außen", "die Expansion nach Korea", "die Verfolgung des Buddhismus"], explanation: "Ab den 1630er Jahren war der Außenhandel überwiegend auf Niederländer und Chinesen in Nagasaki beschränkt; Japaner durften das Land nicht verlassen." },
    fr: { question: "La politique du sakoku sous le shogunat Tokugawa signifiait…", options: ["une éducation obligatoire des samouraïs dans les écoles", "la fermeture quasi totale au contact étranger", "l’expansion vers la Corée", "la persécution du bouddhisme"], explanation: "À partir des années 1630, le commerce extérieur fut confiné surtout aux Néerlandais et aux Chinois à Nagasaki ; les Japonais ne pouvaient partir." },
  },
  'eq33': {
    de: { question: "Welche europäische Nation allein unterhielt unter Sakoku einen Handelsposten in Japan, auf Dejima?", options: ["Portugal mit seiner Gewürzroute", "Spanien mit seinen Silberflotten", "England mit seinem Wollhandel", "Die Niederlande"], explanation: "Die protestantischen Niederländer, als Händler statt als Missionare angesehen, behielten den winzigen Posten auf der Insel Dejima in der Bucht von Nagasaki." },
    fr: { question: "Sous le sakoku, quelle nation européenne conserva seule un comptoir au Japon, à Dejima ?", options: ["Le Portugal et sa route des épices", "L’Espagne et ses flottes d’argent", "L’Angleterre et son commerce de laine", "Les Provinces-Unies"], explanation: "Les Néerlandais protestants, vus comme des marchands plutôt que des missionnaires, conservèrent le minuscule comptoir de l’îlot de Dejima, dans la baie de Nagasaki." },
  },
  'eq34': {
    de: { question: "Die Ukiyo-e-Holzschnitte des Edo-Japans stellten welche „fließende Welt“ dar?", options: ["Buddhistische Paradiese und die Wächter der Tempeltore", "Vergnügungsviertel, Kabuki-Schauspieler, Landschaften", "Kaiserliche Zeremonien am Hof von Kyoto", "Seeschlachten der verfeindeten Klans"], explanation: "Künstler wie Hokusai und Hiroshige druckten in Massen Bilder des Stadtlebens und des Reisens — die später europäische Maler elektrisierten." },
    fr: { question: "Les estampes ukiyo-e du Japon d’Edo dépeignaient quel « monde flottant » ?", options: ["Des paradis bouddhistes et les gardiens des portes", "Quartiers de plaisir, acteurs de kabuki, paysages", "Les cérémonies impériales à la cour de Kyoto", "Des batailles navales entre clans rivaux"], explanation: "Des artistes comme Hokusai et Hiroshige produisirent en masse des images de la vie urbaine et du voyage — électrisant plus tard les peintres européens." },
  },
  'eq35': {
    de: { question: "Nikolaus Kopernikus’ „De revolutionibus“ (1543) schlug vor, dass …", options: ["Bahnen elliptisch und nicht kreisförmig sind", "die Erde und die Planeten die Sonne umkreisen", "die Schwerkraft im Quadrat der Entfernung abnimmt", "das Universum unendlich und ohne Mitte ist"], explanation: "Sein heliozentrisches Modell forderte die ptolemäische Astronomie heraus und setzte die wissenschaftliche Revolution in Gang." },
    fr: { question: "« De revolutionibus » de Nicolas Copernic (1543) proposa que…", options: ["les orbites sont elliptiques et non circulaires", "la Terre et les planètes tournent autour du Soleil", "la gravité faiblit comme le carré de la distance qui sépare", "l’univers est infini et dépourvu de centre"], explanation: "Son modèle héliocentrique remit en cause l’astronomie ptolémaïque et mit en marche la révolution scientifique." },
  },
  'eq36': {
    de: { question: "Johannes Kepler entdeckte, dass sich Planeten bewegen in …", options: ["vollkommenen Kreisen mit der Sonne im Mittelpunkt", "Spiralen, die sich stetig nach innen ziehen", "Ellipsen mit der Sonne in einem Brennpunkt", "Epizyklen auf Kreisen größeren Radius"], explanation: "Keplers Gesetze, aus Tycho Brahes Daten abgeleitet, ersetzten die Kreisbahnen durch Ellipsen." },
    fr: { question: "Johannes Kepler découvrit que les planètes se meuvent selon…", options: ["des cercles parfaits centrés sur le Soleil", "des spirales se resserrant vers le centre", "des ellipses avec le Soleil à un foyer", "des épicycles portés par de plus grands cercles"], explanation: "Les lois de Kepler, tirées des données de Tycho Brahe, remplacèrent les orbites circulaires par des ellipses." },
  },
  'eq37': {
  ...
  'eq38': {
    de: { question: "Ludwigs XIV. Finanzminister, der die französische Staatsindustrie und die Marine aufbaute, war …", options: ["Kardinal Richelieu, erster Minister", "Jean-Baptiste Colbert", "Kardinal Mazarin, erster Minister", "Turgot, der reformierende Kontrolleur"], explanation: "Colberts Merkantilismus — Zölle, Manufakturen und Flotten — finanzierte die Kriege des Sonnenkönigs und Versailles." },
    fr: { question: "Le ministre des Finances de Louis XIV qui bâtit l’industrie d’État française et la marine était…", options: ["Le cardinal de Richelieu, principal ministre", "Jean-Baptiste Colbert", "Le cardinal Mazarin, principal ministre", "Turgot, contrôleur général réformateur"], explanation: "Le mercantilisme de Colbert — tarifs, manufactures et flottes — finança les guerres du Roi-Soleil et Versailles." },
  },
  'eq39': {
    de: { question: "Das Edikt von Nantes (1598), von Ludwig XIV. 1685 widerrufen, hatte was gewährt?", options: ["Freihandel mit England und den Niederlanden", "Duldung der französischen Protestanten", "Unabhängigkeit für die niederländischen Provinzen", "Land für aus dem Osten heimkehrende Kreuzfahrer"], explanation: "Sein Widerruf trieb Hunderttausende geschickte Hugenotten ins Exil — eine selbst zugefügte wirtschaftliche Wunde." },
    fr: { question: "L’édit de Nantes (1598), révoqué par Louis XIV en 1685, avait accordé…", options: ["le libre-échange avec l’Angleterre et la Hollande", "la tolérance aux protestants français", "l’indépendance aux provinces des Provinces-Unies", "des terres aux croisés revenant d’Orient"], explanation: "Sa révocation jeta en exil des centaines de milliers de huguenots qualifiés — une blessure économique auto-infligée." },
  },
  'eq40': {
    de: { question: "Englands Glorreiche Revolution von 1688 führte zu …", options: ["einer Republik unter Cromwell mit vollständig abgeschaffter Monarchie", "Wilhelm und Maria, die eine Bill of Rights annahmen", "einer katholischen Restauration", "der Union mit Schottland"], explanation: "Die Einladung des Parlaments an Wilhelm von Oranien begründete eine konstitutionelle, rechtsgebundene Monarchie." },
    fr: { question: "La Glorieuse Révolution d’Angleterre de 1688 aboutit à…", options: ["une république sous Cromwell avec la monarchie purement abolie", "Guillaume et Marie acceptant une Déclaration des droits", "une restauration catholique", "l’union avec l’Écosse"], explanation: "L’invitation du Parlement à Guillaume d’Orange établit une monarchie constitutionnelle et soumise à la loi." },
  },
  'eq41': {
  ...
  'eq44': {
    de: { question: "Das Konzil von Trient (1545–1563) und die 1540 von Ignatius von Loyola gegründeten Jesuiten waren die zwei Triebkräfte welcher Bewegung?", options: ["Der protestantischen Reformation Luthers", "Der katholischen Gegenreformation", "Der wissenschaftlichen Revolution Galileis", "Der Aufklärung der Philosophen"], explanation: "Das Konzil von Trient reformierte die Lehre, und die disziplinierten, gebildeten Jesuiten wurden die „Stoßtruppen“ der Gegenreformation." },
    fr: { question: "Le concile de Trente (1545–1563) et les Jésuites, fondés en 1540 par Ignace de Loyola, furent les deux moteurs de quel mouvement ?", options: ["La Réforme protestante de Luther", "La Contre-Réforme catholique", "La révolution scientifique de Galilée", "Les Lumières des philosophes"], explanation: "Le concile de Trente réforma la doctrine et les Jésuites disciplinés et instruits devinrent les « troupes de choc » de la Contre-Réforme." },
  },
  'eq45': {
  ...
  'eq46': {
    de: { question: "Welches Buch von Nikolaus Kopernikus aus dem Jahr 1543 argumentierte, dass die Erde um die Sonne kreist?", options: ["Philosophiæ Naturalis Principia Mathematica", "Über die Umschwünge der himmlischen Kreise", "Sidereus Nuncius, oder Der Sternenbote", "Vom Geist der Gesetze, in einunddreißig Büchern"], explanation: "Kopernikus’ „Über die Umschwünge der himmlischen Kreise“ (1543) leitete den Sturz des erdzentrierten Weltbilds ein." },
    fr: { question: "Quel ouvrage de 1543 de Nicolas Copernic soutint que la Terre tourne autour du Soleil ?", options: ["Philosophiæ Naturalis Principia Mathematica", "Des révolutions des sphères célestes", "Sidereus Nuncius, ou Le messager des étoiles", "De l’esprit des lois, en trente et un livres"], explanation: "« Des révolutions des sphères célestes » de Copernic (1543) amorça le renversement du cosmos centré sur la Terre." },
  },
  'eq47': {
  ...
  'eq50': {
    de: { question: "Was bewirkten Japans „Sakoku“-Erlasse der 1630er Jahre?", options: ["Sie öffneten alle großen Häfen für europäische Kaufleute und Missionare", "Sie schlossen Japan bis auf einen Posten auf Dejima", "Sie gaben den Daimyo die Kontrolle über ihre Außenpolitik", "Sie ersetzten das Shogunat durch einen kaiserlichen Rat"], explanation: "Die Sakoku-Erlasse („geschlossenes Land“) verboten Japanern die Ausreise und Fremden die Einreise und ließen nur chinesische und niederländische Händler auf Dejima in Nagasaki zu." },
    fr: { question: "Que firent les édits « sakoku » du Japon des années 1630 ?", options: ["Ils ouvrirent tous les grands ports aux marchands et missionnaires européens", "Ils fermèrent le Japon hormis un comptoir à Dejima", "Ils donnèrent aux daimyos le contrôle de leur politique étrangère", "Ils remplacèrent le shogunat par un conseil impérial"], explanation: "Les édits sakoku (« pays fermé ») interdirent aux Japonais de partir et aux étrangers d’entrer, ne tolérant que les marchands chinois et néerlandais à Dejima, à Nagasaki." },
  },
  'mod1': {
  ...
  'mod2': {
    de: { question: "Was war 1914 der unmittelbare Auslöser des Ersten Weltkriegs?", options: ["Deutschlands Einmarsch in Belgien ohne Warnung", "Der Untergang der Lusitania durch ein U-Boot", "Die Ermordung des Erzherzogs Franz Ferdinand", "Russlands Mobilmachung an der Grenze"], explanation: "Die Ermordung des österreichisch-ungarischen Thronfolgers Franz Ferdinand in Sarajevo durch den serbischen Nationalisten Gavrilo Princip löste das Bündnissystem aus, das Europa in den Krieg zog." },
    fr: { question: "Quel fut le déclencheur immédiat de la Première Guerre mondiale en 1914 ?", options: ["L’invasion de la Belgique par l’Allemagne", "Le naufrage du Lusitania torpillé par un U-Boot", "L’assassinat de l’archiduc François-Ferdinand", "La mobilisation de l’armée russe à la frontière"], explanation: "L’assassinat de l’archiduc austro-hongrois François-Ferdinand à Sarajevo par le nationaliste serbe Gavrilo Princip déclencha le jeu des alliances qui entraîna l’Europe dans la guerre." },
  },
  'mod3': {
  ...
  'mod5': {
    de: { question: "Der Kalte Krieg war vor allem ein ideologischer Konflikt zwischen welchen beiden Systemen?", options: ["Demokratie und Faschismus in Europa", "Kapitalismus/Demokratie und Kommunismus", "Christentum und Islam weltweit", "Kolonialismus und Nationalismus in Asien"], explanation: "Der Kalte Krieg stellte den kapitalistisch-demokratischen Westen (angeführt von den USA) gegen den kommunistischen Osten (angeführt von der UdSSR)." },
    fr: { question: "La guerre froide fut avant tout un conflit idéologique entre quels deux systèmes ?", options: ["La démocratie et le fascisme en Europe", "Le capitalisme et le communisme", "Le christianisme et l’islam dans le monde", "Le colonialisme et le nationalisme en Asie"], explanation: "La guerre froide opposa l’Ouest capitaliste et démocratique (mené par les États-Unis) à l’Est communiste (mené par l’URSS)." },
  },
  'mod6': {
    de: { question: "Kubakrise 1962 — was war die sowjetische Rechtfertigung für die Stationierung von Raketen auf Kuba?", options: ["Kuba vor einer weiteren US-Invasion zu schützen", "Die USA hatten von der Türkei aus Raketen auf die UdSSR gerichtet", "Kuba erbat sowjetischen Atomschutz", "Die UdSSR wollte einen Marinestützpunkt in der Karibik"], explanation: "Obwohl auch die amerikanischen Jupiter-Raketen in der Türkei ein Faktor in den Verhandlungen waren, war die erklärte sowjetische Rechtfertigung der Schutz Kubas nach der gescheiterten, von der CIA gestützten Invasion in der Schweinebucht 1961." },
    fr: { question: "Crise des missiles de Cuba de 1962 — quelle fut la justification soviétique du déploiement de missiles à Cuba ?", options: ["Protéger Cuba d’une nouvelle invasion américaine", "Les États-Unis avaient des missiles pointés sur l’URSS depuis la Turquie", "Cuba demanda une protection nucléaire soviétique", "L’URSS voulait une base navale dans les Caraïbes"], explanation: "Bien que les missiles américains Jupiter en Turquie aient aussi pesé dans les négociations, la justification soviétique déclarée était la protection de Cuba après l’échec de l’invasion de la baie des Cochons, soutenue par la CIA, en 1961." },
  },
  'mod7': {
  ...
  'mod14': {
    de: { question: "Die amerikanische „Domino-Theorie“ — zur Rechtfertigung der Intervention in Vietnam herangezogen — behauptete, dass …", options: ["kommunistische Länder wie Dominosteine zusammenbrächen", "wenn ein Land fiele, die Nachbarländer folgen würden", "wirtschaftliche Entwicklung die Ausbreitung des Kommunismus verhinderte", "Militärbündnisse wie eine Reihe fallender Dominosteine seien"], explanation: "Die von Präsident Eisenhower 1954 popularisierte Domino-Theorie besagte, dass, wenn ein Land dem Kommunismus verfiele (wie Vietnam), die Nachbarländer nacheinander fallen würden. Dieses Denken trieb das US-Engagement in Südostasien an." },
    fr: { question: "La « théorie des dominos » américaine — invoquée pour justifier l’intervention au Vietnam — soutenait que…", options: ["les pays communistes s’effondreraient comme des dominos", "si un pays tombait, ses voisins suivraient", "le développement économique empêchait la propagation du communisme", "les alliances militaires étaient comme une rangée de dominos"], explanation: "La théorie des dominos, popularisée par le président Eisenhower en 1954, affirmait que si un pays tombait au communisme (comme le Vietnam), les pays voisins tomberaient l’un après l’autre. Cette pensée guida l’engagement américain en Asie du Sud-Est." },
  },
  'mod15': {
  ...
  'mod16': {
    de: { question: "James Watts verbesserte Dampfmaschine (1769 patentiert) verwandelte die Industrie vor allem, indem sie …", options: ["Elektrizität aus einem entfernten Kraftwerk nutzte", "Drehkraft fernab von Flüssen praktikabel machte", "mit Benzin lief", "den Kohleverbrauch beseitigte"], explanation: "Watts separater Kondensator und die Drehbewegung befreiten die Fabriken von den Standorten der Wasserräder." },
    fr: { question: "La machine à vapeur perfectionnée de James Watt (brevetée en 1769) transforma l’industrie surtout en…", options: ["utilisant l’électricité produite par une centrale lointaine", "rendant la force rotative pratique loin des rivières", "fonctionnant à l’essence", "supprimant l’usage du charbon"], explanation: "Le condenseur séparé et l’engrenage rotatif de Watt libérèrent les usines des sites de roues à eau." },
  },
  'mod17': {
  ...
  'mod19': {
    de: { question: "Die Berliner Konferenz von 1884–85 wird verbunden mit …", options: ["der deutschen Einigung unter preußischer Vorherrschaft", "den Regeln für die europäische Aufteilung Afrikas", "dem Kongresssystem der europäischen Großmächte", "der Flottenabrüstung zwischen den Großmächten"], explanation: "Die europäischen Mächte legten Ansprüche und Regeln der „effektiven Besetzung“ für Afrika fest — kein afrikanischer Vertreter war anwesend." },
    fr: { question: "La conférence de Berlin de 1884–85 est associée à…", options: ["l’unification allemande sous la direction prussienne", "les règles du partage européen de l’Afrique", "le système du Congrès entre grandes puissances", "le désarmement naval entre les grandes puissances"], explanation: "Les puissances européennes fixèrent des revendications et des règles d’« occupation effective » pour l’Afrique — aucun représentant africain n’y assista." },
  },
  'mod20': {
    de: { question: "Welcher Krieg von 1904–05 endete damit, dass eine asiatische Macht zum ersten Mal in der Neuzeit eine europäische Großmacht besiegte?", options: ["Der Krimkrieg gegen Russland", "Der Russisch-Japanische Krieg", "Der Chinesisch-Japanische Krieg um Korea", "Der Boxerkrieg in Nordchina"], explanation: "Japans Vernichtung der russischen Flotte bei Tsushima erschütterte Europa und beflügelte antikoloniale Bewegungen." },
    fr: { question: "Quelle guerre de 1904–05 s’acheva par la victoire, pour la première fois à l’ère moderne, d’une puissance asiatique sur une grande puissance européenne ?", options: ["La guerre de Crimée contre la Russie", "La guerre russo-japonaise", "La guerre sino-japonaise pour la Corée", "La guerre des Boxers en Chine du Nord"], explanation: "La destruction par le Japon de la flotte russe à Tsushima bouleversa l’Europe et inspira les mouvements anticoloniaux." },
  },
  'mod21': {
  ...
  'mod22': {
    de: { question: "Der Vertrag von Versailles (1919) verlangte von Deutschland, dass es …", options: ["seine gesamte Marine und Handelsflotte an Frankreich abtritt", "die Kriegsschuld anerkennt, Reparationen zahlt und abrüstet", "sofort als Gründungsmitglied dem Völkerbund beitritt", "den Kaiser wieder auf den Thron setzt"], explanation: "Artikel 231 (Kriegsschuld), Reparationen und militärische Beschränkungen nährten anhaltende Verbitterung, die von Extremisten ausgenutzt wurde." },
    fr: { question: "Le traité de Versailles (1919) exigea de l’Allemagne qu’elle…", options: ["cède sa marine et sa flotte marchande à la France", "reconnaisse la culpabilité de guerre, paie et désarme", "rejoigne immédiatement la Société des Nations comme membre fondateur", "restaure le Kaiser sur le trône impérial"], explanation: "L’article 231 (culpabilité de guerre), les réparations et les limites militaires engendrèrent un ressentiment durable exploité par les extrémistes." },
  },
  'mod23': {
  ...
  'mod27': {
    de: { question: "Stalins erster Fünfjahresplan (1928) zielte vor allem auf …", options: ["Konsumgüter für gewöhnliche Haushalte", "Schwerindustrie und Kollektivierung", "marktwirtschaftliche Reform der Preise", "den Ausbau der kaiserlichen Marine"], explanation: "Die halsbrecherische Industrialisierung wurde durch die Kollektivierung bezahlt, die eine Hungersnot auslöste — darunter den Holodomor in der Ukraine." },
    fr: { question: "Le premier plan quinquennal de Staline (1928) visait avant tout…", options: ["les biens de consommation des ménages ordinaires", "l’industrie lourde et la collectivisation agricole", "une réforme libérale des prix et du commerce", "l’expansion de la marine impériale"], explanation: "L’industrialisation à marche forcée fut payée par la collectivisation, qui déclencha une famine — dont l’Holodomor en Ukraine." },
  },
  'mod28': {
    de: { question: "Die Große Säuberung von 1936–38 in der UdSSR umfasste …", options: ["die Ausweisung ausländischer Diplomaten und Schließung der Botschaften", "Schauprozesse und Massenerschießungen in der Partei", "allein das Verbot der Religion", "die Landverteilung"], explanation: "Stalins Terror verschlang alte Bolschewiki, Offiziere der Roten Armee und Hunderttausende gewöhnliche Menschen." },
    fr: { question: "La Grande Terreur de 1936–38 en URSS comporta…", options: ["l’expulsion des diplomates étrangers et la fermeture des ambassades", "des procès-spectacles et exécutions de masse du parti", "seulement l’interdiction de la religion", "la redistribution des terres"], explanation: "La terreur de Staline dévora de vieux bolcheviks, des officiers de l’Armée rouge et des centaines de milliers de gens ordinaires." },
  },
  'mod29': {
    de: { question: "Die Weimarer Hyperinflation von 1923 ist in Erinnerung geblieben für …", options: ["Bankverstaatlichungen auf Anordnung des Weimarer Staates", "Geld, das man in Schubkarren transportierte", "eine goldgedeckte Mark", "Verbote von Fremdwährungen"], explanation: "Die Preise verdoppelten sich in Tagen; Ersparnisse lösten sich auf und radikalisierten die deutsche Mittelschicht." },
    fr: { question: "L’hyperinflation de Weimar de 1923 est restée célèbre pour…", options: ["des nationalisations bancaires ordonnées par Weimar", "une monnaie transportée en brouettes", "un mark adossé à l’or", "l’interdiction des devises étrangères"], explanation: "Les prix doublaient en quelques jours ; les épargnes s’évaporèrent, radicalisant la classe moyenne allemande." },
  },
  'mod30': {
    de: { question: "Das Münchner Abkommen von 1938 gestattete NS-Deutschland die Annexion …", options: ["Österreichs samt seiner Alpenprovinzen", "des Polnischen Korridors und Danzigs", "des Sudetenlandes der Tschechoslowakei", "Elsass-Lothringens und des ganzen Saargebiets"], explanation: "Britannien und Frankreich nahmen Hitlers Anspruch auf die tschechischen Grenzgebiete an — „Frieden für unsere Zeit“ hielt kein Jahr." },
    fr: { question: "Les accords de Munich de 1938 permirent à l’Allemagne nazie d’annexer…", options: ["l’Autriche et ses provinces alpines", "le corridor polonais et Dantzig", "les Sudètes de Tchécoslovaquie", "l’Alsace-Lorraine et le bassin de la Sarre"], explanation: "La Grande-Bretagne et la France acceptèrent la revendication d’Hitler sur les régions frontalières tchèques — la « paix pour notre temps » dura moins d’un an." },
  },
  'mod31': {
    de: { question: "Das Unternehmen Barbarossa (Juni 1941) war …", options: ["die alliierte Landung in der Normandie", "Deutschlands Überfall auf die Sowjetunion", "Japans Pazifikoffensive bei Midway", "der alliierte Feldzug in Nordafrika bei El Alamein"], explanation: "Die größte Invasion der Geschichte brach den Hitler-Stalin-Pakt und eröffnete die tödlichste Front des Krieges." },
    fr: { question: "L’opération Barbarossa (juin 1941) fut…", options: ["le débarquement allié en Normandie", "l’invasion de l’Union soviétique par l’Allemagne", "l’offensive japonaise dans le Pacifique à Midway", "la campagne d’Afrique du Nord à El Alamein"], explanation: "La plus grande invasion de l’histoire rompit le pacte germano-soviétique et ouvrit le front le plus meurtrier de la guerre." },
  },
  'mod32': {
  ...
  'mod35': {
    de: { question: "Die Vereinten Nationen wurden 1945 auf einer Konferenz in welcher Stadt gegründet?", options: ["New York, am East River", "Genf, am Genfersee", "San Francisco", "London, an der Themse"], explanation: "Fünfzig Nationen unterzeichneten die UN-Charta im Juni 1945 in San Francisco." },
    fr: { question: "L’Organisation des Nations unies fut fondée en 1945 lors d’une conférence dans quelle ville ?", options: ["New York, sur l’East River", "Genève, au bord du Léman", "San Francisco", "Londres, sur la Tamise"], explanation: "Cinquante nations signèrent la Charte des Nations unies à San Francisco en juin 1945." },
  },
  'mod36': {
    de: { question: "Der Marshallplan (1948) war darauf angelegt, …", options: ["Deutschland gegen die Sowjetunion wiederzubewaffnen", "Europa aufzubauen und den Kommunismus zu dämpfen", "die neu gegründeten Vereinten Nationen zu finanzieren", "das Militärbündnis NATO zu gründen"], explanation: "Rund 13 Milliarden Dollar US-Hilfe belebten die vom Krieg verwüsteten westeuropäischen Volkswirtschaften." },
    fr: { question: "Le plan Marshall (1948) visait à…", options: ["réarmer l’Allemagne face à l’Union soviétique menaçante", "reconstruire l’Europe et contenir le communisme", "financer l’ONU nouvellement créée", "créer l’alliance militaire de l’OTAN"], explanation: "Environ 13 milliards de dollars d’aide américaine ranimèrent les économies d’Europe occidentale dévastées par la guerre." },
  },
  'mod37': {
    de: { question: "Die Berliner Luftbrücke (1948–49) war eine Antwort auf …", options: ["den Bau der Berliner Mauer quer durch die Stadt", "eine sowjetische Blockade West-Berlins", "eine Hungersnot im besetzten Deutschland", "einen kommunistischen Putsch in Ostdeutschland"], explanation: "Alliierte Flugzeuge versorgten elf Monate lang 2 Millionen West-Berliner, bis Stalin die Blockade aufhob." },
    fr: { question: "Le pont aérien de Berlin (1948–49) répondait à…", options: ["la construction du mur de Berlin à travers la ville", "un blocus soviétique de Berlin-Ouest", "une famine dans l’Allemagne occupée", "un coup d’État communiste en Allemagne de l’Est"], explanation: "Les avions alliés ravitaillèrent 2 millions de Berlinois de l’Ouest pendant 11 mois, jusqu’à ce que Staline lève le blocus." },
  },
  'mod38': {
    de: { question: "Mahatma Gandhis Salzmarsch von 1930 protestierte gegen …", options: ["Baumwollzölle auf indische Stoffe", "das britische Salzmonopol und die Salzsteuer", "die Rassentrennung in den Eisenbahnwagen", "Landbeschlagnahmungen durch den Kolonialstaat"], explanation: "Der 380 km lange Marsch, um in Dandi Salz zu gewinnen, verwandelte eine alltägliche Steuer in eine moralische Anklage der Kolonialherrschaft." },
    fr: { question: "La marche du sel de Mahatma Gandhi en 1930 protestait contre…", options: ["les tarifs sur le coton et les tissus indiens", "le monopole britannique du sel et sa taxe", "la ségrégation dans les voitures de chemin de fer", "les saisies de terres par l’État colonial"], explanation: "La marche de 380 km pour récolter du sel à Dandi transforma une taxe banale en réquisitoire moral contre la domination coloniale." },
  },
  'mod39': {
  ...
  'mod41': {
    de: { question: "Henry Fords Einführung des Fließbands 1913 ist vor allem bedeutsam, weil sie …", options: ["das Automobil und den Verbrennungsmotor überhaupt erfand", "das Automobil durch Massenproduktion verbilligte", "Dampf durch Elektrizität ersetzte", "die Kinderarbeit in Fabriken beendete"], explanation: "Fords laufendes Fließband senkte die Produktionskosten drastisch und machte das Automobil erschwinglich — ein Kennzeichen der Zweiten Industriellen Revolution." },
    fr: { question: "L’introduction par Henry Ford de la chaîne de montage mobile en 1913 est surtout importante parce qu’elle…", options: ["inventa l’automobile et le moteur à combustion interne", "rendit l’automobile abordable par la production de masse", "remplaça la vapeur par l’électricité", "mit fin au travail des enfants dans les usines"], explanation: "La chaîne de montage mobile de Ford abaissa fortement les coûts et rendit l’automobile abordable — une marque de la seconde révolution industrielle." },
  },
  'mod42': {
    de: { question: "Bis 1851 hatte die Industrialisierung Britannien zur weltweit ersten … gemacht.", options: ["Atommacht", "mehrheitlich städtischen Nation", "parlamentarischen Demokratie", "Kolonialmacht"], explanation: "Bauern, die in die Industriestädte strömten, machten Britannien bis 1851 zur weltweit ersten mehrheitlich städtischen Nation." },
    fr: { question: "Vers 1851, l’industrialisation avait fait de la Grande-Bretagne la première nation au monde…", options: ["dotée de l’énergie nucléaire", "à majorité urbaine", "à démocratie parlementaire", "à empire colonial"], explanation: "Les paysans affluant vers les villes industrielles firent de la Grande-Bretagne, vers 1851, la première nation au monde à majorité urbaine." },
  },
  'mod43': {
    de: { question: "Die Nürnberger Prozesse (1945–46) waren bedeutsam, weil sie den Präzedenzfall schufen für …", options: ["kollektive Kriegsschuld eines besiegten Staates", "die individuelle strafrechtliche Verantwortlichkeit", "Zwangsreparationen unter alliierter Verwaltung", "dauerhafte Entmilitarisierung durch die Besatzungsmacht"], explanation: "Nürnberg schuf den Präzedenzfall, dass Einzelne nach Völkerrecht strafrechtlich für Kriegsverbrechen und Verbrechen gegen die Menschlichkeit haften können." },
    fr: { question: "Les procès de Nuremberg (1945–46) furent importants parce qu’ils établirent le précédent de…", options: ["la culpabilité collective d’un État vaincu", "la responsabilité pénale individuelle", "des réparations imposées par une commission alliée", "une démilitarisation permanente imposée par l’occupant"], explanation: "Nuremberg établit le précédent que des individus pouvaient être pénalement responsables, selon le droit international, de crimes de guerre et de crimes contre l’humanité." },
  },
  'mod44': {
    de: { question: "Auf dem Tiefpunkt der Großen Depression 1932 erreichte die Arbeitslosigkeit etwa 25 % in Amerika und nahezu welches Niveau in Deutschland?", options: ["Etwa 10 %", "Etwa 15 %", "Nahezu 30 %", "Nahezu 50 %"], explanation: "Die deutsche Arbeitslosigkeit näherte sich 1932 30 %; der Zusammenbruch des Vertrauens in die Demokratie verhalf Hitler 1933 zur Macht." },
    fr: { question: "Au plus fort de la Grande Dépression en 1932, le chômage atteignit environ 25 % en Amérique et presque quel niveau en Allemagne ?", options: ["Environ 10 %", "Environ 15 %", "Près de 30 %", "Près de 50 %"], explanation: "Le chômage allemand approcha les 30 % en 1932 ; l’effondrement de la confiance dans la démocratie aida Hitler à prendre le pouvoir en 1933." },
  },
  'mod45': {
    de: { question: "Die Kubakrise von 1962 wurde teils durch ein geheimes US-Abkommen gelöst, seine Jupiter-Raketen aus welchem Land abzuziehen?", options: ["Italien", "der Türkei", "Westdeutschland", "Griechenland"], explanation: "Öffentlich versprachen die USA, Kuba nicht zu überfallen; geheim stimmten sie dem Abzug ihrer Jupiter-Raketen aus der Türkei zu." },
    fr: { question: "La crise des missiles de Cuba de 1962 fut résolue en partie par un accord secret des États-Unis de retirer leurs missiles Jupiter de quel pays ?", options: ["l’Italie", "la Turquie", "l’Allemagne de l’Ouest", "la Grèce"], explanation: "Publiquement, les États-Unis s’engagèrent à ne pas envahir Cuba ; secrètement, ils acceptèrent de retirer leurs missiles Jupiter de Turquie." },
  },
  'mod46': {
    de: { question: "Die UdSSR eröffnete das Wettrennen im All 1957 mit dem Start des ersten künstlichen Satelliten namens …", options: ["Wostok", "Sputnik", "Sojus", "Mir"], explanation: "Sputnik (1957) war der erste künstliche Satellit; die UdSSR brachte dann 1961 Juri Gagarin in eine Umlaufbahn." },
    fr: { question: "L’URSS ouvrit la course à l’espace en 1957 en lançant le premier satellite artificiel, nommé…", options: ["Vostok", "Spoutnik", "Soyouz", "Mir"], explanation: "Spoutnik (1957) fut le premier satellite artificiel ; l’URSS mit ensuite Youri Gagarine en orbite en 1961." },
  },
  'mod47': {
    de: { question: "Welche von Otto von Bismarck einberufene Konferenz von 1884–85 legte die Regeln für die Aufteilung Afrikas fest, ohne dass afrikanische Vertreter anwesend waren?", options: ["Der Wiener Kongress", "Die Berliner Konferenz", "Die Konferenz von Jalta", "Der Berliner Kongress (1878)"], explanation: "Die Berliner Konferenz von 1884–85 ließ 14 europäische und amerikanische Nationen Afrikas Grenzen ziehen — unter völliger Missachtung der afrikanischen Völker." },
    fr: { question: "Quelle conférence de 1884–85, convoquée par Otto von Bismarck, fixa les règles du partage de l’Afrique sans aucun représentant africain présent ?", options: ["Le congrès de Vienne", "La conférence de Berlin", "La conférence de Yalta", "Le congrès de Berlin (1878)"], explanation: "La conférence de Berlin de 1884–85 laissa 14 nations européennes et américaines tracer les frontières de l’Afrique, ignorant totalement ses peuples." },
  },
  'mod48': {
    de: { question: "Äthiopien bewahrte seine Unabhängigkeit, indem es ein einfallendes italienisches Heer in welcher Schlacht von 1896 vernichtete?", options: ["Isandlwana", "Adua", "Omdurman", "Rorke’s Drift"], explanation: "Bei Adua (1896) vernichteten die Truppen Kaiser Meneliks II. ein italienisches Heer und zwangen Italien, die äthiopische Unabhängigkeit anzuerkennen." },
    fr: { question: "L’Éthiopie préserva son indépendance en anéantissant une armée italienne d’invasion à quelle bataille de 1896 ?", options: ["Isandlwana", "Adoua", "Omdourman", "Rorke’s Drift"], explanation: "À Adoua (1896), les forces de l’empereur Ménélik II détruisirent une armée italienne, forçant l’Italie à reconnaître l’indépendance éthiopienne." },
  },
  'mod49': {
    de: { question: "Das Massaker vom Juli 1995 an über 8.000 bosniakischen Männern und Jungen in einer von der UNO erklärten „Schutzzone“ — der schlimmste Völkermord in Europa seit dem Zweiten Weltkrieg — fand statt in …", options: ["Vukovar", "Srebrenica", "Sarajevo", "Mostar"], explanation: "In Srebrenica ermordeten Truppen unter General Ratko Mladić über 8.000 Bosniaken; der Internationale Gerichtshof wertete dies als Völkermord." },
    fr: { question: "Le massacre de juillet 1995 de plus de 8 000 hommes et garçons bosniaques dans une « zone de sécurité » déclarée par l’ONU — le pire génocide en Europe depuis la Seconde Guerre mondiale — eut lieu à…", options: ["Vukovar", "Srebrenica", "Sarajevo", "Mostar"], explanation: "À Srebrenica, des forces commandées par le général Ratko Mladić assassinèrent plus de 8 000 Bosniaques ; la Cour internationale de justice qualifia cela de génocide." },
  },
  'mod50': {
    de: { question: "Nach Deng Xiaopings ab 1978 begonnenen Marktreformen wuchs China drei Jahrzehnte lang mit nahezu welcher jährlichen Rate — dem schnellsten anhaltenden Wachstum der Geschichte?", options: ["Nahezu 3 %", "Nahezu 5 %", "Nahezu 10 %", "Nahezu 20 %"], explanation: "China wuchs nach 1978 drei Jahrzehnte lang mit fast 10 % jährlich und holte Hunderte Millionen Menschen aus der Armut." },
  ...
  'bq4': {
    de: { question: 'Die Menschen, die wir „Byzantiner“ nennen, nannten sich selbst...', options: ['Byzantiner, nach Byzanz','Griechen, nach Griechenland','Romaioi — Römer','Hellenen, nach Hellas'], explanation: 'Sie sahen ihren Staat schlicht als das fortbestehende Reich der Römer; „Byzanz“ ist ein Etikett späterer Historiker.' },
    fr: { question: 'Les gens que nous appelons « Byzantins » se nommaient eux-mêmes...', options: ['Byzantins, d’après Byzance','Grecs, d’après la Grèce','Romaioi — Romains','Hellènes, d’après l’Hellade'], explanation: 'Ils voyaient leur État simplement comme l’Empire des Romains qui continuait ; « Byzance » est une étiquette d’historiens ultérieurs.' },
  },
  'bq5': {
  ...
  'bq7': {
    de: { question: 'Justinians große Kodifikation des römischen Rechts ist bekannt als...', options: ['Die Zwölftafeln Roms','Der Codex Hammurabi','Das Corpus Juris Civilis','Die Magna Carta des englischen Königs'], explanation: 'Codex, Digesten und Institutionen bilden zusammen das Corpus Juris Civilis — den Ahnherrn der zivilrechtlichen Systeme Europas.' },
    fr: { question: 'La grande codification du droit romain par Justinien est connue sous le nom de...', options: ['Les Douze Tables de Rome','Le Code de Hammourabi','Le Corpus Juris Civilis','La Magna Carta d’Angleterre'], explanation: 'Le Code, le Digeste et les Institutes forment ensemble le Corpus Juris Civilis — l’ancêtre des systèmes de droit civil d’Europe.' },
  },
  'bq8': {
  ...
  'bq13': {
    de: { question: '988 bekehrte Fürst Wladimir von Kiew sein Reich zu welchem Glauben?', options: ['Römischer Katholizismus aus dem Westen','Islam von den Wolgabulgaren','Orthodoxes Christentum','Judentum von den Chasaren'], explanation: 'Die Taufe der Rus brachte das kyrillische Alphabet, Ikonen und byzantinisches Christentum in die ostslawische Welt.' },
    fr: { question: 'En 988, le prince Vladimir de Kiev convertit son royaume à quelle foi ?', options: ['Catholicisme romain venu d’Occident','Islam venu des Bulgares de la Volga','Christianisme orthodoxe','Judaïsme venu des Khazars'], explanation: 'Le baptême de la Rus’ apporta l’alphabet cyrillique, les icônes et le christianisme byzantin au monde slave oriental.' },
  },
  'bq14': {
    de: { question: '1204 wurde Konstantinopel geplündert von...', options: ['Den Seldschuken aus Anatolien','Den Heeren des Vierten Kreuzzugs','Den Mongolen der westlichen Steppe','Den Persern des Sasanidenreichs'], explanation: 'Von Ägypten abgelenkt, erstürmte und plünderte der Vierte Kreuzzug drei Tage lang die größte Stadt der Christenheit.' },
    fr: { question: 'En 1204, Constantinople fut mise à sac par...', options: ['Les Turcs seldjoukides d’Anatolie','Les armées de la quatrième croisade','Les Mongols de la steppe occidentale','Les Perses de l’empire sassanide'], explanation: 'Détournée de l’Égypte, la quatrième croisade prit d’assaut et pilla trois jours durant la plus grande ville de la chrétienté.' },
  },
  'bq15': {
  ...
  'bq17': {
    de: { question: 'Das von Konstantin einberufene Konzil von Nizäa 325 brachte hervor...', options: ['Das Corpus Juris Civilis Justinians','Das Nizänische Glaubensbekenntnis','Das Edikt von Mailand','Das Große Schisma von 1054'], explanation: 'Das erste ökumenische Konzil bestimmte den christlichen Kernglauben im Nizänum, das bis heute gesprochen wird.' },
  ...
  'bq20': {
    de: { question: 'Der Nika-Aufstand von 532 begann unter den Parteien welcher Institution?', options: ['Des in der Hauptstadt stationierten Heeres','Des Senats von Konstantinopel','Des Wagenrenn-Hippodroms','Der Kirche und ihres Patriarchen'], explanation: 'Die Blauen und Grünen des Hippodroms vereinten sich gegen Justinians Steuern und hätten den Thron fast gestürzt.' },
    fr: { question: 'La sédition Nika de 532 commença parmi les factions de quelle institution ?', options: ['L’armée cantonnée dans la capitale','Le Sénat de Constantinople','L’hippodrome des courses de chars','L’Église et son patriarche'], explanation: 'Les Bleus et les Verts de l’hippodrome s’unirent contre les impôts de Justinien et faillirent défaire le trône.' },
  },
  'bq21': {
  ...
  'bq22': {
    de: { question: 'Ab 541 wurde Justinians Herrschaft verdüstert durch...', options: ['Eine gotische Invasion Italiens','Eine große Pestpandemie','Den Verlust Ägyptens an Persien','Den Ikonoklasmus in den Kirchen'], explanation: 'Die Justinianische Pest fegte über das Mittelmeer, tötete Millionen und erschöpfte Schatzkammer und Heer.' },
    fr: { question: 'À partir de 541, le règne de Justinien fut assombri par...', options: ['Une invasion gothique de l’Italie','Une grande pandémie de peste','La perte de l’Égypte au profit de la Perse','L’iconoclasme dans les églises'], explanation: 'La peste de Justinien balaya la Méditerranée, tuant des millions et épuisant le trésor et l’armée.' },
  },
  'bq23': {
  ...
  'bq26': {
    de: { question: 'Das „Themen“-System organisierte das Reich neu durch...', options: ['Die Teilung der Kirche in Diözesen und Metropolitansitze','Die Ansiedlung von Wehrbauern in Militärbezirken','Die Besteuerung der Klöster und ihrer Ländereien','Die Anwerbung wikingischer Söldner für die Garde'], explanation: 'Auf Erbland angesiedelte Soldaten verteidigten ihre eigene Heimat — ein schlankeres, selbsttragendes Reich.' },
    fr: { question: 'Le système des « thèmes » réorganisa l’empire par...', options: ['La division de l’Église en diocèses et en métropoles','L’installation de soldats-paysans dans les thèmes','L’imposition des monastères et de leurs terres','Le recrutement de mercenaires vikings pour la garde'], explanation: 'Des soldats établis sur des terres héréditaires défendaient leurs propres foyers — un empire plus svelte et autosuffisant.' },
  },
  'bq27': {
  ...
  'bq30': {
    de: { question: 'Die endgültige Wiederherstellung der Ikonen 843 wird in orthodoxen Kirchen gefeiert als...', options: ['Das Osterfest Pascha','Der Triumph der Orthodoxie','Das Pfingstfest der Kirche','Die Kreuzerhöhung im September'], explanation: 'Die Wiederherstellung der Kaiserin Theodora wird jedes Jahr am ersten Sonntag der Großen Fastenzeit begangen.' },
  ...
  'bq32': {
    de: { question: 'Die Sprache der Bibel- und Liturgieübersetzungen der Brüder heißt...', options: ['Byzantinisches Griechisch des Hofes','Altkirchenslawisch','Bulgarisch des Ersten Reiches','Makedonisch des Vardartals'], explanation: 'Das Altkirchenslawische wurde die heilige und literarische Sprache der slawisch-orthodoxen Welt.' },
    fr: { question: 'La langue des traductions bibliques et liturgiques des frères s’appelle...', options: ['Le grec byzantin de la cour','Le vieux-slave','Le bulgare du premier empire','Le macédonien de la vallée du Vardar'], explanation: 'Le vieux-slave devint la langue sacrée et littéraire du monde slave orthodoxe.' },
  },
  'bq33': {
  ...
  'bq38': {
    de: { question: 'Basileios II. verdiente seinen düsteren Beinamen durch die Eroberung wessen Reiches?', options: ['Des serbischen Reiches Stefan Dušans','Des bulgarischen Reiches Samuels','Der Kiewer Rus Wladimirs','Des Seldschukensultanats Rum'], explanation: 'Sein langer Krieg gegen Samuel — dessen Hauptstadt in Ohrid lag — trug ihm den Namen „Bulgarentöter“ ein.' },
    fr: { question: 'Basile II gagna son sinistre surnom par la conquête de quel empire ?', options: ['L’empire serbe d’Étienne Dušan','L’empire bulgare de Samuel','La Rus’ de Kiev de Vladimir','Le sultanat seldjoukide de Roum'], explanation: 'Sa longue guerre contre Samuel — dont la capitale se trouvait à Ohrid — lui valut le nom de « tueur de Bulgares ».' },
  },
  'bq39': {
    de: { question: 'Bei Manzikert 1071 geschah, was einem römischen Kaiser sieben Jahrhunderte nicht widerfahren war — was?', options: ['Er fiel in der Schlachtreihe','Er wurde vom Feind lebend gefangen','Er trat in Gefangenschaft zum Islam über','Er dankte auf dem Schlachtfeld ab'], explanation: 'Romanos IV. geriet in die Gefangenschaft Sultan Alp Arslans; die folgenden Bürgerkriege verloren Anatolien.' },
    fr: { question: 'À Manzikert en 1071, il arriva ce qui n’était pas arrivé à un empereur romain depuis sept siècles — quoi ?', options: ['Il mourut dans la ligne de bataille','Il fut pris vivant par l’ennemi','Il se convertit à l’islam en captivité','Il abdiqua sur le champ de bataille'], explanation: 'Romain IV fut capturé par le sultan Alp Arslan ; les guerres civiles qui suivirent perdirent l’Anatolie.' },
  },
  'bq40': {
  ...
  'bq43': {
    de: { question: 'Historiker stellen die Verteidigung Konstantinopels 717–18 neben die Schlacht von Tours, weil beide...', options: ['Das Zeitalter der schweren Reiterei beendeten','Die religiöse Landkarte Europas mitentschieden','Das Perserreich im Osten zerstörten','Das Schießpulver in Krieg und Belagerung einführten'], explanation: 'Wäre die Hauptstadt 718 gefallen, hätte dem Kalifat der Weg auf den Balkan und nach Europa offen gestanden.' },
    fr: { question: 'Les historiens rangent la défense de Constantinople en 717–18 aux côtés de la bataille de Tours parce que les deux...', options: ['Mirent fin à l’âge de la cavalerie lourde','Aidèrent à décider la carte religieuse de l’Europe','Détruisirent l’Empire perse d’Orient','Introduisirent la poudre dans la guerre et le siège'], explanation: 'Si la capitale était tombée en 718, la route du Califat vers les Balkans et l’Europe eût été ouverte.' },
  },
  'bq44': {
  ...
  'bq45': {
    de: { question: 'Obwohl Kyrill die Glagoliza erfand, wurde das „Kyrillisch“ genannte Alphabet tatsächlich entwickelt von...', options: ['Kyrill selbst während seiner Mission in Rom','Dem Schülerkreis in Ohrid und Preslaw','Der kaiserlichen Kanzlei','Fränkischen Missionaren'], explanation: 'Die Generation des Klemens von Ohrid baute die einfachere Schrift auf griechischer Grundlage und benannte sie nach dem Gründer der Mission.' },
    fr: { question: 'Bien que Cyrille eût inventé le glagolitique, l’alphabet appelé « cyrillique » fut en réalité développé par...', options: ['Cyrille lui-même lors de sa mission à Rome','Le cercle de ses disciples à Ohrid et Preslav','La chancellerie impériale','Des missionnaires francs'], explanation: 'La génération de Clément d’Ohrid bâtit l’écriture plus simple à base grecque et la nomma en l’honneur du fondateur de la mission.' },
  },
  'bq46': {
    de: { question: 'Die „Dreisprachen-Häresie“, die Kyrill bekämpfte, besagte, Gott dürfe nur auf Hebräisch, Griechisch und Latein verehrt werden — den Sprachen...', options: ['Der drei Weisen aus dem Morgenland','Der Kreuzesinschrift','Der Septuaginta-Übersetzung','Der zwölf Apostel Christi'], explanation: 'Kyrill verachtete den Anspruch, der auf der dreisprachigen Inschrift über dem gekreuzigten Christus fußte: Fällt der Regen nicht auf alle Völker gleich?' },
    fr: { question: 'L’« hérésie des trois langues » que combattit Cyrille soutenait que Dieu ne pouvait être adoré qu’en hébreu, grec et latin — les langues de...', options: ['Des trois mages venus d’Orient','De l’inscription de la Croix','De la traduction de la Septante','Des douze apôtres du Christ'], explanation: 'Cyrille méprisa cette prétention, fondée sur l’inscription trilingue au-dessus du Christ crucifié : la pluie ne tombe-t-elle pas également sur tous les peuples ?' },
  },
  'bq47': {
  ...
  'bq48': {
    de: { question: 'Das Edikt von 1046 über den Berg Athos, bis heute in Kraft, verfügt, dass...', options: ['Nur gebürtige Griechen Mönche werden dürfen','Keine Frau die Halbinsel betreten darf','Klöster keine kaiserlichen Steuern zahlen','Der Berg allein dem Kaiser gehört'], explanation: 'Im monastischen Denken ist der Berg der Garten der Gottesmutter, ihr allein vorbehalten.' },
    fr: { question: 'L’édit de 1046 concernant le mont Athos, toujours en vigueur, décrète que...', options: ['Seuls les Grecs de naissance peuvent être moines','Aucune femme ne peut fouler la péninsule','Les monastères ne paient pas d’impôts impériaux','La montagne appartient au seul empereur'], explanation: 'Dans la pensée monastique, la Montagne est le jardin de la Mère de Dieu, réservé à elle seule.' },
  },
  'bq49': {
    de: { question: 'Während der letzten Belagerung 1453 umging Mehmed II. die Kette über das Goldene Horn, indem er...', options: ['Sie mit dem Feuer der großen Bombarde zerschoss','Siebzig Schiffe über Land schleppen ließ','Die Genuesen von Galata bestach, sie zu öffnen','Eine Pontonbrücke über die Bucht baute'], explanation: 'Die hinter der Kette zu Wasser gelassenen Schiffe zwangen die Verteidiger, ihre wenigen Männer über noch mehr Mauern zu verteilen.' },
    fr: { question: 'Pendant le siège final de 1453, Mehmed II contourna la chaîne de la Corne d’Or en...', options: ['La brisant à coups de grande bombarde','Faisant haler soixante-dix navires par terre','Soudoyant les Génois de Galata pour la faire ouvrir','Construisant un pont de pontons sur la corne'], explanation: 'Les navires lancés derrière la chaîne forcèrent les défenseurs à étirer leurs rares hommes sur encore plus de murailles.' },
  },
  'bq50': {
    de: { question: 'Byzantinische Flüchtlinge wie Bessarion prägten die italienische Renaissance vor allem, indem sie...', options: ['Pulverwaffen in den italienischen Stadtstaaten einführten','Griechische Handschriften und die Kunst, sie zu lesen','Florentiner Banken finanzierten','Die ersten Fresken malten'], explanation: 'Die Flut griechischer Bücher und Lehrer nach 1453 nährte die humanistische Wiedergewinnung Platons und der Klassiker.' },
    fr: { question: 'Les réfugiés byzantins comme Bessarion façonnèrent la Renaissance italienne avant tout en...', options: ['Introduisant les armes à poudre dans les cités italiennes','Apportant des manuscrits grecs et l’art de les lire','Finançant les banques florentines','Peignant les premières fresques'], explanation: 'Le flot de livres et de maîtres grecs après 1453 nourrit la redécouverte humaniste de Platon et des classiques.' },
  },
  // ── PREHISTORIC (preq1–preq50) ───────────────────────────────────────────────
  'preq1': {
    de: { question: "Die ersten bekannten Homininen, wie Sahelanthropus (~7 Mio. Jahre), wurden in Afrika gefunden. Was war die erste große menschliche Anpassung?", options: ["Ein großes und komplexes Gehirn", "Der aufrechte Gang auf zwei Beinen", "Der kontrollierte Gebrauch des Feuers", "Die voll ausgebildete Lautsprache"], explanation: "Der aufrechte Gang — nicht ein großes Gehirn — kam zuerst und befreite die Hände. Alles Übrige folgte aus diesen befreiten Händen." },
    fr: { question: "Les premiers hominidés connus, comme Sahélanthrope (~7 M.a.), furent trouvés en Afrique. Quelle fut la première grande adaptation humaine ?", options: ["Un cerveau grand et complexe", "La marche debout sur deux jambes", "L’usage maîtrisé du feu", "Le langage parlé pleinement formé"], explanation: "La bipédie — et non un grand cerveau — vint d’abord, libérant les mains. Tout le reste découla de ces mains libérées." },
  },
  'preq2': {
    de: { question: "Das berühmte Fossil „Lucy“, das vor ~3,2 Mio. Jahren lebte, gehörte zu welcher Art?", options: ["Homo habilis, der geschickte Mensch", "Australopithecus afarensis", "Homo erectus, der aufrechte Mensch", "Paranthropus boisei, der Nussknacker"], explanation: "Lucy war ein Australopithecus afarensis; ihr Becken und Knie beweisen, dass sie völlig aufrecht ging, obwohl ihr Gehirn klein war." },
    fr: { question: "Le célèbre fossile « Lucy », qui vécut il y a ~3,2 M.a., appartenait à quelle espèce ?", options: ["Homo habilis, l’homme habile", "Australopithecus afarensis", "Homo erectus, l’homme debout", "Paranthropus boisei, le casse-noix"], explanation: "Lucy était un Australopithecus afarensis ; son bassin et son genou prouvent qu’elle marchait pleinement debout bien que son cerveau fût petit." },
  },
  'preq3': {
    de: { question: "Die Fußspuren von Laetoli in Tansania (~3,6 Mio. Jahre) sind wichtig, weil sie beweisen …", options: ["Den ersten Gebrauch von Steinwerkzeugen zum Zerlegen von Fleisch", "Dass Homininen vor großen Gehirnen aufrecht gingen", "Die früheste Beherrschung des Feuers", "Die erste Bestattung der Toten"], explanation: "Die Spuren mit modernem Gewölbe und nach vorn weisender großer Zehe zeigen den aufrechten Gang eine Million Jahre vor den ersten Steinwerkzeugen." },
    fr: { question: "Les empreintes de Laetoli en Tanzanie (~3,6 M.a.) sont importantes car elles prouvent…", options: ["Le premier usage d’outils de pierre pour découper la viande", "Que les hominidés marchaient debout avant le grand cerveau", "La plus ancienne maîtrise du feu", "La première inhumation des morts"], explanation: "Les empreintes, à la voûte moderne et au gros orteil pointant vers l’avant, montrent la marche debout un million d’années avant les premiers outils de pierre." },
  },
  'preq4': {
  ...
  'preq7': {
    de: { question: "Der tropfenförmige acheuléische Faustkeil war vor allem bemerkenswert, weil …", options: ["Er aus Bronze und nicht aus Stein bestand", "Er eine Million Jahre unverändert blieb", "Er nur für Krieg und Jagd verwendet wurde", "Er von Homo sapiens in Afrika erfunden wurde"], explanation: "Derselbe symmetrische Entwurf wurde über eine Million Jahre in Afrika, Europa und Asien gefertigt — die langlebigste Technik der Menschheitsgeschichte." },
    fr: { question: "Le biface acheuléen en forme de larme fut remarquable surtout parce que…", options: ["Il était fait de bronze plutôt que de pierre taillée", "Il resta inchangé pendant un million d’années", "Il ne servait qu’à la guerre et à la chasse", "Il fut inventé par Homo sapiens en Afrique"], explanation: "Le même dessin symétrique fut fabriqué en Afrique, en Europe et en Asie pendant plus d’un million d’années — la technologie la plus durable de l’histoire humaine." },
  },
  'preq8': {
  ...
  'preq11': {
    de: { question: "Australien vor mindestens 50.000 Jahren zu erreichen ist erstaunlich, weil es … erforderte.", options: ["Eine Landbrücke zu Fuß zu überqueren", "Absichtliche Seereisen zu unternehmen", "Eine lange Wüstendurchquerung zu überleben", "Die ersten festen Städte zu bauen"], explanation: "Selbst bei den niedrigsten eiszeitlichen Meeresspiegeln bedeutete Australien zu erreichen, offenen Ozean zu überqueren — der älteste Beleg für Seefahrt." },
    fr: { question: "Atteindre l’Australie il y a au moins 50 000 ans est stupéfiant car cela exigeait…", options: ["De traverser un pont terrestre à pied", "Des traversées maritimes délibérées", "De survivre à une longue traversée du désert", "De bâtir les premières villes permanentes"], explanation: "Même aux plus bas niveaux marins de la glaciation, atteindre l’Australie signifiait traverser la haute mer — la plus ancienne preuve de navigation." },
  },
  'preq12': {
  ...
  'preq13': {
    de: { question: "Die Landwirtschaft (die Neolithische Revolution) begann vor etwa 10.000 Jahren zuerst in welcher Region?", options: ["Das Niltal in Ägypten", "Der Fruchtbare Halbmond", "Nordchina und der Gelbe Fluss", "Zentralmexiko und seine Täler"], explanation: "Der Fruchtbare Halbmond hatte eine seltene Ansammlung wilder Pflanzen und Tiere zur Domestikation — Weizen, Gerste, Schafe und Ziegen." },
    fr: { question: "L’agriculture (la révolution néolithique) débuta il y a environ 10 000 ans d’abord dans quelle région ?", options: ["La vallée du Nil en Égypte", "Le Croissant fertile", "Le nord de la Chine et le fleuve Jaune", "Le centre du Mexique et ses vallées"], explanation: "Le Croissant fertile avait un rare ensemble de plantes et d’animaux sauvages propices à la domestication — blé, orge, moutons et chèvres." },
  },
  'preq14': {
    de: { question: "Göbekli Tepe (~9500 v. Chr.) stürzte alte Theorien um, weil diese monumentale Steinstätte errichtet wurde …", options: ["Von den ersten Königen Ägyptens, nach der Reichseinigung", "Von Jägern und Sammlern, vor der Landwirtschaft", "Mit Eisenwerkzeugen und Wagen auf Speichenrädern", "Nach der Erfindung der Schrift in Sumer und Akkad"], explanation: "Die älteste monumentale Architektur errichteten Jäger und Sammler, was andeutet, dass der Wunsch, sich zum Ritual zu versammeln, zur Sesshaftigkeit trieb." },
    fr: { question: "Göbekli Tepe (~9500 av. J.-C.) renversa les vieilles théories car ce site monumental de pierre fut bâti…", options: ["Par les premiers rois d’Égypte, après l’unification du pays", "Par des chasseurs-cueilleurs, avant l’agriculture", "Avec des outils de fer et des chariots à roues", "Après l’invention de l’écriture en Basse-Mésopotamie"], explanation: "La plus ancienne architecture monumentale fut dressée par des chasseurs-cueilleurs, suggérant que le désir de se rassembler pour le rituel poussa vers la vie sédentaire." },
  },
  'preq15': {
  ...
  'preq17': {
    de: { question: "Das Fossil „Lucy“ erhielt seinen Spitznamen nach …", options: ["Der Tochter des Wissenschaftlers", "Einem Beatles-Lied im Lager", "Dem Tal, in dem es gefunden wurde", "Einem lokalen Afar-Wort für Schönheit"], explanation: "Sie wurde nach „Lucy in the Sky with Diamonds“ benannt, das im Ausgrabungslager lief." },
    fr: { question: "Le fossile « Lucy » reçut son surnom d’après…", options: ["La fille du scientifique, restée à la maison", "Une chanson des Beatles au campement", "La vallée où il fut trouvé, en Éthiopie", "Un mot afar local signifiant beauté"], explanation: "Elle fut nommée d’après « Lucy in the Sky with Diamonds », qui passait au campement de fouilles." },
  },
  'preq18': {
    de: { question: "Paranthropus boisei wurde wegen seiner … „Nussknackermensch“ genannt.", options: ["Angewohnheit, harte Nüsse mit schweren Steinen zu knacken", "Massiven Zähne und Kiefer für zähe Wurzeln", "Nussförmigen Schädels", "Ernährung nur aus Baumnüssen"], explanation: "Der schwerkiefrige „robuste“ Australopithecine hatte Zähne, die zum Zermahlen zäher Pflanzenkost gebaut waren." },
    fr: { question: "Paranthropus boisei fut surnommé « l’Homme casse-noix » à cause de ses…", options: ["L’habitude de casser des noix dures avec de lourdes pierres", "Dents et mâchoires massives pour broyer les racines", "Crâne en forme de noix", "Régime uniquement de noix d’arbre"], explanation: "L’australopithèque « robuste » à mâchoire lourde avait des dents faites pour broyer des végétaux coriaces." },
  },
  'preq19': {
    de: { question: "Die moderne Wissenschaft beschreibt die menschliche Evolution nicht als Leiter, sondern als …", options: ["Einen geraden Marsch des Fortschritts zum modernen Menschen", "Einen verzweigten Busch voller Sackgassen", "Eine einzige ununterbrochene Linie", "Einen Kreis, der zum Ursprung zurückkehrt"], explanation: "Mehrere Homininenarten koexistierten oft; wir sind die einzigen Überlebenden einer einst dicht bevölkerten, verzweigten Familie." },
    fr: { question: "La science moderne décrit l’évolution humaine non comme une échelle, mais comme…", options: ["Une marche rectiligne du progrès vers l’homme moderne", "Un buisson ramifié fait d’impasses", "Une seule lignée ininterrompue", "Un cercle revenant à son origine"], explanation: "Plusieurs espèces d’hominidés coexistèrent souvent ; nous sommes les seuls survivants d’une famille jadis populeuse et ramifiée." },
  },
  'preq20': {
  ...
  'preq29': {
    de: { question: "Die Denisova-Menschen wurden 2010 erstmals anhand eines Fingerknochens aus einer Höhle wo identifiziert?", options: ["der Altai-Region in Sibirien", "dem Zagros-Gebirge im Iran", "der Levante und ihren Höhlen", "der Insel Flores in Indonesien"], explanation: "Ein einzelner Fingerknochen aus der Denisova-Höhle in Sibirien lieferte die DNA einer zuvor unbekannten Menschenpopulation." },
    fr: { question: "Les Dénisoviens furent identifiés pour la première fois en 2010 à partir d’un os de doigt trouvé dans une grotte où ?", options: ["la région de l’Altaï en Sibérie", "les monts Zagros en Iran", "le Levant et ses grottes", "l’île de Florès dans l’archipel indonésien"], explanation: "Un seul os de doigt de la grotte de Denisova, en Sibérie, livra l’ADN d’une population humaine jusqu’alors inconnue." },
  },
  'preq30': {
  ...
  'preq33': {
    de: { question: "Warum tragen Völker außerhalb Afrikas weniger genetische Vielfalt als Afrikaner?", options: ["Sie entwickelten sich langsamer als andere Menschengruppen", "Sie von einer kleinen Gründerpopulation abstammen", "Sie vermischten sich weniger", "Afrikas Klima erhöhte die Mutation"], explanation: "Fast alle außerhalb Afrikas Lebenden stammen von einer vergleichsweise kleinen Gruppe ab, die Afrika vor ~60.000–70.000 Jahren verließ." },
    fr: { question: "Pourquoi les peuples hors d’Afrique portent-ils moins de diversité génétique que les Africains ?", options: ["Ils ont évolué plus lentement que les autres groupes humains", "Ils descendent d’une petite population fondatrice", "Ils se sont moins métissés", "Le climat de l’Afrique augmenta la mutation"], explanation: "Presque tous ceux qui vivent hors d’Afrique descendent d’un groupe relativement petit qui quitta l’Afrique il y a ~60 000–70 000 ans." },
  },
  'preq34': {
  ...
  'preq38': {
    de: { question: "Die Erfindung von Nadeln mit Öhr im Jungpaläolithikum erlaubte den Menschen …", options: ["Mit Netzen und Reusen zu fischen", "Passgenaue Kleidung zu nähen", "Körbe aus Schilf zu flechten", "Löcher in harten Stein zu bohren"], explanation: "Knochennadeln mit Öhr erlaubten eiszeitlichen Menschen, passgenaue Kleidung zu nähen, entscheidend zum Überleben der Kälte." },
    fr: { question: "L’invention d’aiguilles à chas au Paléolithique supérieur permit aux gens de…", options: ["Pêcher au filet et à la nasse", "Coudre des vêtements ajustés", "Tresser des paniers de roseaux", "Percer la pierre dure"], explanation: "Les aiguilles en os à chas permirent aux gens de la glaciation de coudre des vêtements ajustés, cruciaux pour survivre au froid." },
  },
  'preq39': {
    de: { question: "Um welchen Zeitpunkt kamen Pfeil und Bogen in weiten Gebrauch?", options: ["Vor 2 Mio. Jahren, in Afrika", "Das Ende der Eiszeit", "Die Bronzezeit des Vorderen Orients", "Die Römerzeit im Westen"], explanation: "Der Bogen — der einem Jäger erlaubte, lautlos aus der Ferne zu töten — war gegen Ende der Eiszeit weit verbreitet." },
    fr: { question: "Vers quel moment l’arc et la flèche entrèrent-ils en usage répandu ?", options: ["Il y a 2 M d’années, en Afrique", "La fin de la glaciation", "L’âge du bronze du Proche-Orient", "L’époque romaine en Occident"], explanation: "L’arc — qui permettait à un chasseur de tuer silencieusement de loin — était d’usage répandu à la fin de la glaciation." },
  },
  'preq40': {
  ...
  'preq41': {
    de: { question: "Der 40.000 Jahre alte Löwenmensch von Hohlenstein-Stadel gilt vielleicht als wichtigstes Objekt der Urgeschichte, weil er …", options: ["Die älteste jemals irgendwo gefundene menschliche Skulptur ist", "Ein Wesen darstellt, das es in der Natur nicht gibt", "Aus massivem Gold geschnitzt wurde", "Die ersten Schriftzeichen zeigt"], explanation: "Ein löwenköpfiger Mensch aus Mammutelfenbein stellt etwas nie Gesehenes dar — das Wesen des vorstellenden Geistes." },
    fr: { question: "L’Homme-Lion de Hohlenstein-Stadel, vieux de 40 000 ans, est peut-être l’objet le plus important de la préhistoire car il…", options: ["Est la plus ancienne sculpture humaine jamais retrouvée", "Représente un être qui n’existe pas dans la nature", "Fut sculpté dans l’or massif", "Montre les premiers signes écrits"], explanation: "Un humain à tête de lion sculpté dans l’ivoire de mammouth représente quelque chose de jamais vu — l’essence de l’esprit qui imagine." },
  },
  'preq42': {
  ...
  'preq45': {
    de: { question: "Das Aussterben der eiszeitlichen Megafauna war in Afrika am mildesten. Die beste Erklärung ist, dass afrikanische Tiere …", options: ["Für frühe Jäger schlicht viel zu groß waren, um erlegt zu werden", "Sich Millionen Jahre mit Homininen gemeinsam entwickelt hatten", "Dort lebten, wo sich das Klima nie änderte", "Durch die frühesten Jagdgesetze geschützt waren"], explanation: "Da sie sich über Zeitalter mit Homininen entwickelt hatten, war die afrikanische Megafauna vorsichtiger gegenüber Menschen; das Aussterben traf am härtesten, wo Tiere zum ersten Mal auf Menschen trafen." },
    fr: { question: "Les extinctions de mégafaune glaciaire furent les plus douces en Afrique. La meilleure explication est que les animaux africains…", options: ["Étaient bien trop grands pour être abattus par les premiers chasseurs", "Avaient coévolué avec les hominidés pendant des millions d’années", "Vivaient là où le climat ne changeait jamais", "Étaient protégés par les toutes premières lois de chasse"], explanation: "Ayant évolué aux côtés des hominidés durant des âges, la mégafaune africaine se méfiait davantage des humains ; les extinctions frappèrent le plus fort là où les animaux rencontrèrent les gens pour la première fois." },
  },
  'preq46': {
  ...
  'preq47': {
    de: { question: "Manche Gelehrte nennen die Landwirtschaft „den schlimmsten Fehler in der Geschichte des Menschengeschlechts“, weil die ersten Bauern oft … waren.", options: ["Von ihren nächsten bäuerlichen Nachbarn ausgelöscht", "Kleiner, kränker und abgearbeiteter als Sammler", "Unfähig, Nahrung zu lagern", "Gezwungen, das Feuer aufzugeben"], explanation: "Eine auf wenige Feldfrüchte verengte Ernährung brachte Mangel, faulende Zähne, neue Massenkrankheiten und Hungergefahr — doch die Landwirtschaft siegte, weil sie mehr Menschen ernährte." },
    fr: { question: "Certains savants appellent l’agriculture « la pire erreur de l’histoire de la race humaine » parce que les premiers agriculteurs étaient souvent…", options: ["Exterminés par leurs plus proches voisins agriculteurs", "Plus petits, plus maladifs et plus usés que les cueilleurs", "Incapables de stocker la nourriture", "Contraints d’abandonner le feu"], explanation: "Un régime réduit à quelques cultures apportait carences, dents cariées, nouvelles maladies d’entassement et risque de famine — mais l’agriculture l’emporta en nourrissant plus de gens." },
  },
  'preq48': {
  ...
  'preq49': {
    de: { question: "Die Protostadt Çatalhöyük war auffällig ungewöhnlich, weil ihre Häuser …", options: ["Aus sorgfältig behauenen Steinblöcken gebaut waren", "Durchs Dach betreten wurden, nicht durch Türen", "Einen zentralen Palast und Tempel umgaben", "Auf Holzpfählen über dem Wasser standen"], explanation: "Ihre Lehmziegelhäuser waren Wand an Wand gedrängt; die Menschen gingen über die Dächer und stiegen über Leitern in ihre Häuser hinab." },
    fr: { question: "La proto-ville de Çatalhöyük était frappante d’insolite car ses maisons…", options: ["Étaient faites de blocs de pierre taillée", "On y entrait par le toit, et non par une porte", "Entouraient un palais et un temple central", "Reposaient sur des pilotis de bois au-dessus de l’eau"], explanation: "Ses maisons de brique crue étaient serrées mur contre mur ; les gens marchaient sur les toits et descendaient par des échelles dans leurs logis." },
  },
  'preq50': {
