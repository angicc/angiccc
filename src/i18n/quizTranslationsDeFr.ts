...
export const QUIZ_TRANS_DEFR: Record<string, Partial<Record<DeFr, QuizQuestionTranslation>>> = {
  ...
  'eq34': {
    de: { question: "Die Ukiyo-e-Holzschnitte des Edo-Japans stellten welche „fließende Welt“ dar?", options: ["Buddhistische Paradiese und Tempelwächter", "Vergnügungsviertel, Kabuki-Schauspieler, Landschaften", "Kaiserliche Zeremonien am Hof von Kyoto", "Seeschlachten der verfeindeten Klans"], explanation: "Künstler wie Hokusai und Hiroshige druckten in Massen Bilder des Stadtlebens und des Reisens — die später europäische Maler elektrisierten." },
    fr: { question: "Les estampes ukiyo-e du Japon d’Edo dépeignaient quel « monde flottant » ?", options: ["Des paradis bouddhistes et gardiens de temples", "Quartiers de plaisir, acteurs de kabuki, paysages", "Les cérémonies impériales à la cour de Kyoto", "Des batailles navales entre clans rivaux"], explanation: "Des artistes comme Hokusai et Hiroshige produisirent en masse des images de la vie urbaine et du voyage — électrisant plus tard les peintres européens." },
  },
  'eq35': {
