...
export const QUIZ_TRANS_DEFR: Record<string, Partial<Record<DeFr, QuizQuestionTranslation>>> = {
  ...
  'aq44': {
    de: { question: "Der Mechanismus von Antikythera, aus einem antiken Schiffswrack geborgen, zeigt, wie fortgeschritten die hellenistische Technik war. Was war er?", options: ["Eine römische Katapult zum Brechen von Stadtmauern", "Ein bronzenes Zahnradgerät zur Vorhersage von Finsternissen", "Ein phönizischer Kompass für die Fahrt auf hoher See", "Eine ägyptische Wasseruhr für die Tempelriten"], explanation: "Er war ein bronzener Zahnrad-„Computer“ zur Vorhersage von Finsternissen und Himmelspositionen — eine Technik, die jahrhundertelang nicht mehr erreicht wurde." },
    fr: { question: "La machine d’Anticythère, récupérée d’une épave antique, révèle combien l’ingénierie hellénistique était avancée. Qu’était-ce ?", options: ["Une catapulte romaine pour abattre les remparts", "Un dispositif de bronze à engrenages pour prédire les éclipses", "Une boussole phénicienne pour naviguer en haute mer", "Une clepsydre égyptienne pour rythmer les rites"], explanation: "C’était un « ordinateur » de bronze à engrenages pour prédire éclipses et positions célestes — une ingénierie inégalée pendant bien des siècles." },
  },
  'aq45': {
  ...
  'eq22': {
    de: { question: "Der Augsburger Religionsfriede (1555) begründete welches Prinzip im Heiligen Römischen Reich?", options: ["Freie Religionsausübung für jeden einzelnen Untertan", "Cuius regio, eius religio — der Herrscher wählt den Glauben", "Päpstliche Vorherrschaft über jeden deutschen Fürsten", "Abschaffung der Klöster im gesamten Reich"], explanation: "Jeder Fürst wählte für seine Lande Luthertum oder Katholizismus; Andersgläubige durften auswandern." },
    fr: { question: "La paix d’Augsbourg (1555) établit quel principe dans le Saint-Empire ?", options: ["La liberté de culte pour chaque sujet individuel", "Cuius regio, eius religio — le souverain choisit la foi", "La suprématie papale sur chaque prince allemand", "L’abolition des monastères dans tout l’empire"], explanation: "Chaque prince choisissait le luthéranisme ou le catholicisme pour ses terres ; les dissidents pouvaient émigrer." },
  },
  'eq23': {
  ...
  'mod36': {
    de: { question: "Der Marshallplan (1948) war darauf angelegt, …", options: ["Deutschland gegen die Sowjetunion wiederzubewaffnen", "Europa aufzubauen und den Reiz des Kommunismus zu dämpfen", "die neu gegründeten Vereinten Nationen zu finanzieren", "das Militärbündnis NATO zu gründen"], explanation: "Rund 13 Milliarden Dollar US-Hilfe belebten die vom Krieg verwüsteten westeuropäischen Volkswirtschaften." },
    fr: { question: "Le plan Marshall (1948) visait à…", options: ["réarmer l’Allemagne face à l’Union soviétique", "reconstruire l’Europe et émousser l’attrait communiste", "financer l’ONU nouvellement créée", "créer l’alliance militaire de l’OTAN"], explanation: "Environ 13 milliards de dollars d’aide américaine ranimèrent les économies d’Europe occidentale dévastées par la guerre." },
  },
  'mod37': {
  ...
  'mod43': {
    de: { question: "Die Nürnberger Prozesse (1945–46) waren bedeutsam, weil sie den Präzedenzfall schufen für …", options: ["Reparationen für Kriegsschäden", "die internationale strafrechtliche Verantwortlichkeit für Kriegsverbrechen und Verbrechen gegen die Menschlichkeit", "die Zwei-Staaten-Lösung", "die nukleare Nichtverbreitung"], explanation: "Nürnberg schuf den Präzedenzfall, dass Einzelne nach Völkerrecht strafrechtlich für Kriegsverbrechen und Verbrechen gegen die Menschlichkeit haften können." },
    fr: { question: "Les procès de Nuremberg (1945–46) furent importants parce qu’ils établirent le précédent de…", options: ["réparations pour dommages de guerre", "la responsabilité pénale internationale pour crimes de guerre et crimes contre l’humanité", "la solution à deux États", "la non-prolifération nucléaire"], explanation: "Nuremberg établit le précédent que des individus pouvaient être pénalement responsables, selon le droit international, de crimes de guerre et de crimes contre l’humanité." },
  },
  'mod44': {
