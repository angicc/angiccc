...
export const QUIZ_TRANS_DEFR: Record<string, Partial<Record<DeFr, QuizQuestionTranslation>>> = {
  ...
  'preq7': {
    de: { question: "Der tropfenförmige acheuléische Faustkeil war vor allem bemerkenswert, weil …", options: ["Er aus Bronze bestand", "Er eine Million Jahre unverändert blieb", "Er nur für den Krieg verwendet wurde", "Er von Homo sapiens erfunden wurde"], explanation: "Derselbe symmetrische Entwurf wurde über eine Million Jahre in Afrika, Europa und Asien gefertigt — die langlebigste Technik der Menschheitsgeschichte." },
    fr: { question: "Le biface acheuléen en forme de larme fut remarquable surtout parce que…", options: ["Il était fait de bronze", "Il fut fabriqué inchangé pendant un million d’années", "Il ne servait qu’à la guerre", "Il fut inventé par Homo sapiens"], explanation: "Le même dessin symétrique fut fabriqué en Afrique, en Europe et en Asie pendant plus d’un million d’années — la technologie la plus durable de l’histoire humaine." },
  },
  'preq8': {
