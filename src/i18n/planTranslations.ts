...
const PLAN_FEATURES: Record<string, Partial<Record<ContentLang, string[]>>> = {
  ...
  pro: {
    es: ['Todas las lecciones de las 4 eras', 'Quizzes completos con explicaciones', 'Tutor IA – 50 mensajes/mes', 'Línea de tiempo completa con filtros', 'Quiz Inteligente (IA adaptativa)', 'Tarjetas y repetición espaciada', 'Notas personales y marcadores', 'XP, logros y rachas', 'Analíticas de progreso y ranking', 'Debate con Filósofo (reinicio cada 12 h)', 'Mapa de Territorios – fronteras históricas interactivas'],
    ru: ['Все уроки по 4 эпохам', 'Полные викторины с объяснениями', 'ИИ-Наставник – 50 сообщений/мес', 'Полная хронология с фильтрами', 'Умная Викторина (адаптивный ИИ)', 'Карточки и интервальное повторение', 'Личные заметки и закладки', 'XP, достижения и серии', 'Аналитика прогресса и рейтинг', 'Дискуссия с философом (каждые 12 ч)', 'Карта Территорий – интерактивные исторические границы'],
