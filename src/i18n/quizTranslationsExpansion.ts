...
export const QUIZ_TRANS_EXPANSION: Record<string, Partial<Record<ContentLang, QQT>>> = {
  ...
  'preq1': {
    ...
    ru: { question: 'Древнейшие известные гоминины, как сахелантроп (~7 млн лет), найдены в Африке. Какой была первая великая адаптация человека?', options: ['Большой мозг','Прямохождение на двух ногах','Использование огня','Членораздельная речь'], explanation: 'Прямохождение — а не большой мозг — пришло первым, освободив руки. Всё остальное вытекло из этих освобождённых рук.' },
    mk: { question: 'Најстарите познати хоминини, како Sahelanthropus (~7 милиони години), се пронајдени во Африка. Која беше првата голема човечка адаптација?', options: ['Голем мозок','Исправено одење на две нозе','Употребата на огнот','Говорниот јазик'], explanation: 'Двоножноста — а не голем мозок — дошла прва, ослободувајќи ги рацете. Сè друго произлегло од тие ослободени раце.' },
  },
  'preq2': {
    es: { question: 'El famoso fósil "Lucy", que vivió hace ~3,2 millones de años, ¿a qué especie pertenecía?', options: ['Homo habilis','Australopithecus afarensis','Homo erectus','Paranthropus boisei'], explanation: 'Lucy era un Australopithecus afarensis; su pelvis y rodilla prueban que caminaba plenamente erguida aunque su cerebro era pequeño.' },
    ru: { question: 'Знаменитая ископаемая «Люси», жившая ~3,2 млн лет назад, к какому виду принадлежала?', options: ['Homo habilis','Australopithecus afarensis','Homo erectus','Paranthropus boisei'], explanation: 'Люси была Australopithecus afarensis; её таз и колено доказывают, что она ходила полностью прямо, хотя мозг был мал.' },
    mk: { question: 'Славниот фосил „Луси“, што живеел пред ~3,2 милиони години, на кој вид припаѓал?', options: ['Homo habilis','Australopithecus afarensis','Homo erectus','Paranthropus boisei'], explanation: 'Луси била Australopithecus afarensis; нејзиниот карлица и колено докажуваат дека одела целосно исправено иако мозокот ѝ бил мал.' },
  },
  'preq3': {
    es: { question: 'Las huellas de Laetoli en Tanzania (~3,6 millones de años) son importantes porque prueban...', options: ['El primer uso de herramientas de piedra','Que los homínidos caminaban erguidos mucho antes de los grandes cerebros o las herramientas','El control más temprano del fuego','El primer enterramiento de los muertos'], explanation: 'Las huellas, con un arco moderno y el dedo gordo apuntando al frente, muestran la marcha erguida un millón de años antes de las primeras herramientas de piedra.' },
    ru: { question: 'Следы в Лаэтоли в Танзании (~3,6 млн лет) важны тем, что доказывают...', options: ['Первое использование каменных орудий','Что гоминины ходили прямо задолго до большого мозга и орудий','Раннейшее покорение огня','Первое погребение мёртвых'], explanation: 'Следы с современным сводом и большим пальцем, направленным вперёд, показывают прямохождение за миллион лет до первых каменных орудий.' },
    mk: { question: 'Отпечатоците од Лаетоли во Танзанија (~3,6 милиони години) се важни зашто докажуваат...', options: ['Прва употреба на камени алатки','Дека хоминините оделе исправено долго пред големите мозоци или алатки','Најрано владеење на огнот','Прво погребување на мртвите'], explanation: 'Отпечатоците, со модерен свод и палец свртен нанапред, покажуваат исправено одење милион години пред првите камени алатки.' },
  },
  'preq4': {
    es: { question: 'Las herramientas de piedra más antiguas de la Tierra — el instrumental olduvayense (~2,6 millones de años) — se hicieron primero ¿en qué continente?', options: ['Asia','Europa','África','Australia'], explanation: 'Los cantos tallados y las lascas olduvayenses proceden de Etiopía; la fabricación de herramientas transformó la dieta y, con el tiempo, el cerebro.' },
    ru: { question: 'Древнейшие каменные орудия на Земле — олдувайский набор (~2,6 млн лет) — впервые изготовлены на каком материке?', options: ['Азия','Европа','Африка','Австралия'], explanation: 'Олдувайские рубила и отщепы происходят из Эфиопии; изготовление орудий преобразило рацион и со временем мозг.' },
    mk: { question: 'Најстарите камени алатки на Земјата — олдувајскиот прибор (~2,6 милиони години) — прво биле направени на кој континент?', options: ['Азија','Европа','Африка','Австралија'], explanation: 'Олдувајските сечила и отсечоци потекнуваат од Етиопија; изработката на алат ја преобрази исхраната и, со време, мозокот.' },
  },
  'preq5': {
    es: { question: '¿Qué homínido fue el primero en salir de África?', options: ['Australopithecus afarensis','Homo erectus','Homo sapiens','Los neandertales'], explanation: 'Homo erectus (~1,9 millones de años) se extendió por Asia, dejando fósiles tan lejos como Indonesia y China.' },
    ru: { question: 'Какой гоминин первым вышел из Африки?', options: ['Australopithecus afarensis','Homo erectus','Homo sapiens','Неандертальцы'], explanation: 'Homo erectus (~1,9 млн лет) расселился по Азии, оставив ископаемые вплоть до Индонезии и Китая.' },
    mk: { question: 'Кој хоминин прв ја напуштил Африка?', options: ['Australopithecus afarensis','Homo erectus','Homo sapiens','Неандерталците'], explanation: 'Homo erectus (~1,9 милиони години) се раширил низ Азија, оставајќи фосили дури до Индонезија и Кина.' },
  },
  'preq6': {
    es: { question: 'El primatólogo Richard Wrangham sostuvo que ¿qué actividad fue el verdadero motor de la evolución del cerebro humano?', options: ['Cazar caza mayor','Cocinar la comida con fuego','Fabricar herramientas de piedra','Caminar largas distancias'], explanation: 'Cocinar "predigiere" la comida, liberando más calorías con menos masticación — energía que pagó nuestros cerebros grandes y hambrientos.' },
    ru: { question: 'Приматолог Ричард Рэнгем утверждал, что какая деятельность была подлинным двигателем эволюции человеческого мозга?', options: ['Охота на крупную дичь','Приготовление пищи на огне','Изготовление каменных орудий','Ходьба на дальние расстояния'], explanation: 'Готовка «переваривает» пищу заранее, высвобождая больше калорий при меньшем жевании — энергия, оплатившая наш большой прожорливый мозг.' },
    mk: { question: 'Приматологот Ричард Рангам тврдел дека која активност била вистинскиот мотор на еволуцијата на човечкиот мозок?', options: ['Ловење крупен дивеч','Готвење храна со оган','Изработка на камени алатки','Одење на долги растојанија'], explanation: 'Готвењето „предвари“ ја храната, ослободувајќи повеќе калории со помалку џвакање — енергија што ги платила нашите големи, гладни мозоци.' },
  },
  'preq7': {
    es: { question: 'El bifaz achelense en forma de lágrima fue notable sobre todo por...', options: ['Estar hecho de bronce','Fabricarse casi sin cambios durante más de un millón de años en tres continentes','Usarse solo para la guerra','Ser inventado por Homo sapiens'], explanation: 'El mismo diseño simétrico se fabricó por África, Europa y Asia durante más de un millón de años — la tecnología más longeva de la historia humana.' },
    ru: { question: 'Каплевидное ашёльское рубило было примечательно прежде всего тем, что...', options: ['Было сделано из бронзы','Изготавливалось почти неизменным более миллиона лет на трёх материках','Использовалось только для войны','Было изобретено Homo sapiens'], explanation: 'Тот же симметричный образец изготавливали по Африке, Европе и Азии более миллиона лет — самая долгоживущая технология в истории человека.' },
    mk: { question: 'Ашелската рачна секира во облик на солза била значајна пред сè поради...', options: ['Тоа што била направена од бронза','Тоа што се изработувала речиси непроменета повеќе од милион години на три континенти','Тоа што се користела само за војна','Тоа што ја измислил Homo sapiens'], explanation: 'Истиот симетричен дизајн се изработувал низ Африка, Европа и Азија повеќе од милион години — најдолговечната технологија во човечката историја.' },
  },
  'preq8': {
    es: { question: '¿Aproximadamente qué porcentaje de ADN neandertal portan las personas modernas de ascendencia no africana?', options: ['0 %','1–2 %','10–15 %','Alrededor de la mitad'], explanation: 'El mestizaje de hace unos 50.000–60.000 años dejó ~1–2 % de ADN neandertal en todos los descendientes de quienes salieron de África.' },
    ru: { question: 'Примерно какой процент неандертальской ДНК несут современные люди неафриканского происхождения?', options: ['0 %','1–2 %','10–15 %','Около половины'], explanation: 'Скрещивание около 50 000–60 000 лет назад оставило ~1–2 % неандертальской ДНК у всех потомков покинувших Африку.' },
    mk: { question: 'Приближно колкав процент неандерталска ДНК носат модерните луѓе со неафриканско потекло?', options: ['0 %','1–2 %','10–15 %','Околу половина'], explanation: 'Вкрстувањето пред околу 50.000–60.000 години оставило ~1–2 % неандерталска ДНК кај сите потомци на оние што ја напуштиле Африка.' },
  },
  'preq9': {
    es: { question: 'La prueba de que los neandertales cuidaban a sus enfermos y heridos procede sobre todo ¿de qué cueva?', options: ['Lascaux','Chauvet','Shanidar','Altamira'], explanation: 'En la cueva de Shanidar, en Irak, un hombre gravemente herido sobrevivió durante años — es decir, su banda lo alimentó y cuidó.' },
    ru: { question: 'Свидетельство того, что неандертальцы заботились о больных и раненых, происходит прежде всего из какой пещеры?', options: ['Ласко','Шове','Шанидар','Альтамира'], explanation: 'В пещере Шанидар в Ираке тяжело раненный человек прожил годами — значит, его группа кормила и опекала его.' },
    mk: { question: 'Доказот дека неандерталците се грижеле за болните и повредените потекнува пред сè од која пештера?', options: ['Ласко','Шове','Шанидар','Алтамира'], explanation: 'Во пештерата Шанидар во Ирак, тешко повреден човек преживеал со години — значи неговата група го хранела и се грижела за него.' },
  },
  'preq10': {
    es: { question: 'Nuestra propia especie, Homo sapiens, surgió por primera vez en África ¿hace aproximadamente cuánto tiempo?', options: ['~50.000 años','~120.000 años','~300.000 años','~1 millón de años'], explanation: 'Los fósiles de Homo sapiens más antiguos, de Jebel Irhoud en Marruecos, datan de hace unos 300.000 años.' },
    ru: { question: 'Наш собственный вид, Homo sapiens, впервые возник в Африке примерно как давно?', options: ['~50 000 лет','~120 000 лет','~300 000 лет','~1 млн лет'], explanation: 'Древнейшие ископаемые Homo sapiens из Джебель-Ирхуда в Марокко датируются возрастом около 300 000 лет.' },
    mk: { question: 'Нашиот вид, Homo sapiens, првпат се појавил во Африка пред приближно колку време?', options: ['~50.000 години','~120.000 години','~300.000 години','~1 милион години'], explanation: 'Најстарите фосили на Homo sapiens, од Џебел Ирхуд во Мароко, датираат од пред околу 300.000 години.' },
  },
  'preq11': {
    es: { question: 'Llegar a Australia hace al menos 50.000 años es asombroso porque exigió...', options: ['Cruzar un puente de tierra a pie','Travesías marítimas deliberadas por mar abierto','Sobrevivir a un cruce del desierto','Construir las primeras ciudades'], explanation: 'Incluso con los niveles del mar más bajos de la glaciación, llegar a Australia exigía cruzar mar abierto — la prueba más antigua de navegación en el mundo.' },
    ru: { question: 'Достижение Австралии по меньшей мере 50 000 лет назад поразительно, потому что требовало...', options: ['Перехода по перешейку пешком','Намеренных морских плаваний через открытый океан','Выживания в пустынном переходе','Постройки первых городов'], explanation: 'Даже при самом низком уровне моря ледникового периода достичь Австралии значило пересечь открытый океан — древнейшее свидетельство мореходства.' },
    mk: { question: 'Стигнувањето до Австралија пред најмалку 50.000 години е зачудувачко зашто барало...', options: ['Преминување копнен мост пешки','Намерни морски патувања преку отворен океан','Преживување на пустински премин','Градење на првите градови'], explanation: 'Дури и при најниските нивоа на морето во глацијацијата, стигнувањето до Австралија значело преминување отворен океан — најстариот доказ за морепловство.' },
  },
  'preq12': {
    es: { question: 'Las pinturas rupestres de Chauvet en Francia — leones, rinocerontes y caballos — tienen aproximadamente ¿qué antigüedad?', options: ['~5.000 años','~17.000 años','~36.000 años','~100.000 años'], explanation: 'Las pinturas de Chauvet tienen unos 36.000 años; hay arte figurativo aún más antiguo (un jabalí verrugoso) en Indonesia.' },
    ru: { question: 'Пещерные росписи Шове во Франции — львы, носороги и лошади — примерно какого возраста?', options: ['~5 000 лет','~17 000 лет','~36 000 лет','~100 000 лет'], explanation: 'Росписи Шове возрастом около 36 000 лет; ещё более древнее фигуративное искусство (бородавчатая свинья) известно из Индонезии.' },
    mk: { question: 'Пештерските слики на Шове во Франција — лавови, носорози и коњи — се стари приближно колку?', options: ['~5.000 години','~17.000 години','~36.000 години','~100.000 години'], explanation: 'Сликите на Шове се стари околу 36.000 години; уште постара фигуративна уметност (брадавичесто прасе) е позната од Индонезија.' },
  },
  'preq13': {
    es: { question: 'La agricultura (la Revolución Neolítica) comenzó hace unos 10.000 años primero ¿en qué región?', options: ['El valle del Nilo','El Creciente Fértil','El norte de China','El centro de México'], explanation: 'El Creciente Fértil tenía un raro conjunto de plantas y animales silvestres aptos para la domesticación — trigo, cebada, ovejas y cabras.' },
    ru: { question: 'Земледелие (неолитическая революция) началось около 10 000 лет назад впервые в каком регионе?', options: ['Долина Нила','Плодородный полумесяц','Северный Китай','Центральная Мексика'], explanation: 'На Плодородном полумесяце было редкое скопление диких растений и животных, пригодных для одомашнивания, — пшеница, ячмень, овцы и козы.' },
    mk: { question: 'Земјоделството (Неолитската Револуција) започнало пред околу 10.000 години прво во кој регион?', options: ['Долината на Нил','Плодородниот Полумесец','Северна Кина','Централно Мексико'], explanation: 'Плодородниот Полумесец имал редок збир диви растенија и животни погодни за припитомување — пченица, јачмен, овци и кози.' },
  },
  'preq14': {
    es: { question: 'Göbekli Tepe (~9500 a.C.) trastocó las viejas teorías porque este sitio monumental de piedra fue construido...', options: ['Por los primeros reyes de Egipto','Por cazadores-recolectores, antes de la agricultura y la cerámica','Con herramientas de hierro','Después de la invención de la escritura'], explanation: 'La arquitectura monumental más antigua la levantaron cazadores-recolectores, lo que sugiere que el impulso de reunirse para el ritual pudo empujar hacia la vida asentada.' },
    ru: { question: 'Гёбекли-Тепе (~9500 до н.э.) опрокинул старые теории, потому что этот монументальный каменный памятник был построен...', options: ['Первыми царями Египта','Охотниками-собирателями, до земледелия и гончарства','Железными орудиями','После изобретения письменности'], explanation: 'Древнейшую монументальную архитектуру возвели охотники-собиратели, что намекает: желание собираться ради обряда могло подтолкнуть к осёдлой жизни.' },
    mk: { question: 'Гебекли Тепе (~9500 п.н.е.) ги преврте старите теории зашто овој монументален камен локалитет бил изграден...', options: ['Од првите кралеви на Египет','Од ловци-собирачи, пред земјоделството и грнчарството','Со железни алатки','По изумот на писмото'], explanation: 'Најстарата монументална архитектура ја кренале ловци-собирачи, што наведува дека желбата да се собираат за ритуал можеби турнала кон населен живот.' },
  },
  'preq15': {
    es: { question: '¿Hacia qué fecha aproximada había empezado la profunda edad sin palabras de la prehistoria a dar paso a las ciudades y la escritura?', options: ['10.000 a.C.','3000 a.C.','500 a.C.','1 d.C.'], explanation: 'Hacia el 3000 a.C., las aldeas neolíticas de los grandes valles fluviales se hinchaban en ciudades, y la primera escritura puso fin a la prehistoria.' },
    ru: { question: 'К какой примерно дате глубокая, бессловесная эпоха доистории начала уступать место городам и письменности?', options: ['10 000 до н.э.','3000 до н.э.','500 до н.э.','1 н.э.'], explanation: 'К примерно 3000 году до н.э. неолитические деревни великих речных долин разрастались в города, и первая письменность завершила доисторию.' },
    mk: { question: 'До која приближна датум длабокото, бесзборно доба на праисторијата почнало да им отстапува место на градовите и писмото?', options: ['10.000 п.н.е.','3000 п.н.е.','500 п.н.е.','1 н.е.'], explanation: 'До околу 3000 п.н.е., неолитските села на големите речни долини набабрувале во градови, и првото писмо ѝ ставило крај на праисторијата.' },
  },
  'preq16': {
    es: { question: '¿Quién desenterró a "Lucy" en la región de Afar de Etiopía en 1974?', options: ['Mary Leakey','Louis Leakey','Donald Johanson','Raymond Dart'], explanation: 'El paleoantropólogo Donald Johanson halló cerca del 40 % del esqueleto de Lucy — el fósil más famoso del mundo.' },
    ru: { question: 'Кто откопал «Люси» в области Афар в Эфиопии в 1974 году?', options: ['Мэри Лики','Луис Лики','Дональд Джохансон','Раймонд Дарт'], explanation: 'Палеоантрополог Дональд Джохансон нашёл около 40 % скелета Люси — самого знаменитого ископаемого в мире.' },
    mk: { question: 'Кој ја ископал „Луси“ во регионот Афар во Етиопија во 1974 година?', options: ['Мери Лики','Луис Лики','Доналд Џохансон','Рејмонд Дарт'], explanation: 'Палеоантропологот Доналд Џохансон нашол околу 40 % од скелетот на Луси — најпознатиот фосил во светот.' },
  },
  'preq17': {
    es: { question: 'El fósil "Lucy" recibió su apodo por...', options: ['La hija del científico','Una canción de los Beatles que sonaba en el campamento','El valle donde se halló','Una palabra afar local'], explanation: 'Se le puso el nombre por "Lucy in the Sky with Diamonds", que sonaba en el campamento de excavación.' },
    ru: { question: 'Ископаемая «Люси» получила прозвище в честь...', options: ['Дочери учёного','Песни The Beatles, звучавшей в лагере','Долины, где её нашли','Местного афарского слова'], explanation: 'Её назвали по песне «Lucy in the Sky with Diamonds», которая звучала в лагере раскопок.' },
    mk: { question: 'Фосилот „Луси“ го добил прекарот по...', options: ['Ќерката на научникот','Песна на Битлси што свирела во кампот','Долината каде што е пронајдена','Локален афарски збор'], explanation: 'Наречена е по „Lucy in the Sky with Diamonds“, што свирела во ископувачкиот камп.' },
  },
  'preq18': {
    es: { question: 'A Paranthropus boisei se le apodó "Hombre Cascanueces" por sus...', options: ['Costumbre de partir nueces con piedras','Enormes dientes y mandíbulas para triturar raíces y semillas duras','Cráneo con forma de nuez','Dieta solo de nueces de árbol'], explanation: 'El australopiteco "robusto" de mandíbula pesada tenía dientes hechos para triturar alimentos vegetales duros.' },
    ru: { question: 'Paranthropus boisei прозвали «Щелкунчиком» из-за его...', options: ['Привычки колоть орехи камнями','Массивных зубов и челюстей для перетирания жёстких корней и семян','Ореховидного черепа','Питания только древесными орехами'], explanation: 'У массивночелюстного «робустного» австралопитека были зубы, приспособленные перетирать жёсткую растительную пищу.' },
    mk: { question: 'Paranthropus boisei бил наречен „Оревокршач“ поради неговите...', options: ['Навика да крши ореви со камења','Огромни заби и вилици за мелење тврди корени и семиња','Череп во облик на орев','Исхрана само со дрвени ореви'], explanation: 'Тешкочелусниот „робусен“ австралопитек имал заби направени да мелат тврда растителна храна.' },
  },
  'preq19': {
    es: { question: 'La ciencia moderna describe la evolución humana no como una escalera, sino como...', options: ['Una marcha recta de progreso','Un arbusto ramificado cuyas ramas están casi todas muertas','Una sola línea ininterrumpida','Un círculo que vuelve a su origen'], explanation: 'Varias especies de homínidos coexistieron a menudo; somos los únicos supervivientes de una familia antaño concurrida y ramificada.' },
    ru: { question: 'Современная наука описывает эволюцию человека не как лестницу, а как...', options: ['Прямое шествие прогресса','Ветвящийся куст, почти все ветви которого — тупики','Единую непрерывную линию','Круг, возвращающийся к истоку'], explanation: 'Несколько видов гоминин часто сосуществовали; мы — единственные уцелевшие из некогда многолюдной, ветвящейся семьи.' },
    mk: { question: 'Модерната наука ја опишува човечката еволуција не како скала, туку како...', options: ['Право маршево движење на напредок','Разгрането грмушесто стебло чии гранки речиси сите се слепи улици','Една единствена непрекината линија','Круг што се враќа кон своето потекло'], explanation: 'Повеќе видови хоминини често коегзистирале; ние сме единствените преживеани од некогаш преполнето, разгрането семејство.' },
  },
  'preq20': {
    es: { question: '¿Qué testigo científico reciente permite leer directamente las relaciones genéticas entre pueblos desaparecidos?', options: ['La datación por radiocarbono','El ADN antiguo','El análisis de polen','La dendrocronología'], explanation: 'El ADN antiguo recuperado de huesos viejos revela los vínculos genéticos entre poblaciones humanas extintas.' },
    ru: { question: 'Какой недавний научный свидетель позволяет напрямую читать генетические связи между исчезнувшими народами?', options: ['Радиоуглеродное датирование','Древняя ДНК','Анализ пыльцы','Дендрохронология'], explanation: 'Древняя ДНК, извлечённая из старых костей, раскрывает генетические связи между вымершими человеческими популяциями.' },
    mk: { question: 'Кој неодамнешен научен сведок овозможува директно читање на генетските врски меѓу исчезнатите народи?', options: ['Радиокарбонско датирање','Старата ДНК','Анализа на полен','Дендрохронологија'], explanation: 'Старата ДНК извлечена од стари коски ги открива генетските врски меѓу изумрените човечки популации.' },
  },
  'preq21': {
    es: { question: '"El Hombre de Java" y "el Hombre de Pekín" son fósiles famosos ¿de qué especie?', options: ['Homo habilis','Homo erectus','Homo neanderthalensis','Australopithecus afarensis'], explanation: 'Homo erectus, el primero en salir de África, dejó fósiles por toda Asia, incluidos Indonesia y cerca de Pekín.' },
    ru: { question: '«Яванский человек» и «пекинский человек» — знаменитые ископаемые какого вида?', options: ['Homo habilis','Homo erectus','Homo neanderthalensis','Australopithecus afarensis'], explanation: 'Homo erectus, первым вышедший из Африки, оставил ископаемые по всей Азии, включая Индонезию и окрестности Пекина.' },
    mk: { question: '„Јаванскиот човек“ и „Пекиншкиот човек“ се славни фосили на кој вид?', options: ['Homo habilis','Homo erectus','Homo neanderthalensis','Australopithecus afarensis'], explanation: 'Homo erectus, првиот што ја напуштил Африка, оставил фосили низ цела Азија, вклучувајќи ги Индонезија и близу Пекинг.' },
  },
  'preq22': {
    es: { question: '¿Aproximadamente cuánto perduró Homo erectus como especie?', options: ['Unos 100.000 años','Unos 500.000 años','Casi 2 millones de años','Unos 50.000 años'], explanation: 'Homo erectus duró casi dos millones de años — unas diez veces más de lo que nuestra propia especie ha existido hasta ahora.' },
    ru: { question: 'Примерно как долго Homo erectus существовал как вид?', options: ['Около 100 000 лет','Около 500 000 лет','Почти 2 млн лет','Около 50 000 лет'], explanation: 'Homo erectus просуществовал почти два миллиона лет — примерно в десять раз дольше, чем существует наш собственный вид.' },
    mk: { question: 'Приближно колку долго Homo erectus опстојувал како вид?', options: ['Околу 100.000 години','Околу 500.000 години','Речиси 2 милиони години','Околу 50.000 години'], explanation: 'Homo erectus траел речиси два милиони години — околу десет пати подолго отколку што нашиот вид постои досега.' },
  },
  'preq23': {
    es: { question: 'Huesos quemados y ceniza que sugieren uso del fuego dentro de un refugio hace al menos un millón de años proceden ¿de qué sitio?', options: ['Garganta de Olduvai','Cueva de Wonderwerk','Zhoukoudian','Cueva de Blombos'], explanation: 'La cueva de Wonderwerk, en Sudáfrica, conserva algunas de las pruebas más antiguas de fuego controlado.' },
    ru: { question: 'Обожжённые кости и зола, указывающие на использование огня в укрытии по меньшей мере миллион лет назад, происходят из какого места?', options: ['Олдувайское ущелье','Пещера Вондерверк','Чжоукоудянь','Пещера Бломбос'], explanation: 'Пещера Вондерверк в Южной Африке сохраняет одни из древнейших свидетельств управляемого огня.' },
    mk: { question: 'Изгорени коски и пепел што укажуваат на употреба на оган во засолниште пред најмалку милион години потекнуваат од кое место?', options: ['Клисурата Олдуваи','Пештерата Вондерверк','Џоукоудијан','Пештерата Бломбос'], explanation: 'Пештерата Вондерверк во Јужна Африка чува некои од најстарите докази за контролиран оган.' },
  },
  'preq24': {
    es: { question: 'El cerebro humano es metabólicamente costoso, quemando aproximadamente ¿qué parte de nuestras calorías en reposo?', options: ['Una veinteava parte','Una décima parte','Una quinta parte','La mitad'], explanation: 'El cerebro quema alrededor de una quinta parte de nuestras calorías en reposo — energía que la cocción de la comida ayudó a suministrar.' },
    ru: { question: 'Человеческий мозг метаболически дорог, сжигая в покое примерно какую долю наших калорий?', options: ['Двадцатую','Десятую','Пятую','Половину'], explanation: 'Мозг сжигает около пятой части наших калорий в покое — энергия, которую помогло дать приготовление пищи.' },
    mk: { question: 'Човечкиот мозок е метаболички скап, согорувајќи во мирување приближно кој дел од нашите калории?', options: ['Дваесеттина','Десеттина','Петтина','Половина'], explanation: 'Мозокот согорува околу една петтина од нашите калории во мирување — енергија што готвењето помогнало да се обезбеди.' },
  },
  'preq25': {
    es: { question: 'Los neandertales fueron reconocidos por primera vez a partir de un hallazgo de 1856 ¿en qué país?', options: ['Francia','España','Alemania','Irak'], explanation: 'El espécimen tipo se halló en el valle de Neander (Neandertal), cerca de Düsseldorf, en Alemania.' },
    ru: { question: 'Неандертальцы были впервые распознаны по находке 1856 года в какой стране?', options: ['Франция','Испания','Германия','Ирак'], explanation: 'Типовой образец нашли в Неандертальской долине (Неандерталь) близ Дюссельдорфа в Германии.' },
    mk: { question: 'Неандерталците првпат биле препознаени од наод од 1856 година во која земја?', options: ['Франција','Шпанија','Германија','Ирак'], explanation: 'Типскиот примерок е пронајден во Неандерталската долина (Neandertal) близу Дизелдорф во Германија.' },
  },
  'preq26': {
  ...
  'preq27': {
    ...
    ru: { question: 'В какой пещере неандерталец прожил годами с усохшей рукой и раздробленной глазницей, что подразумевает заботу других?', options: ['Пещера Шанидар','Ласко','Денисова пещера','Шове'], explanation: 'Человек из пещеры Шанидар в Ираке не мог охотиться; его группа должна была кормить и опекать его — свидетельство сострадания.' },
    mk: { question: 'Во која пештера неандерталец преживеал со години со свенната рака и здробена очна дупка, што подразбира дека други се грижеле за него?', options: ['Пештерата Шанидар','Ласко','Пештерата Денисова','Шове'], explanation: 'Човекот од пештерата Шанидар во Ирак не можел да лови; неговата група морала да го храни и да се грижи за него — доказ за сочувство.' },
  },
  'preq28': {
    es: { question: 'Los neandertales poseían ¿qué gen, vinculado en los humanos modernos al lenguaje?', options: ['BRCA1','FOXP2','HAR1','MYH16'], explanation: 'Los neandertales portaban el gen FOXP2, asociado al habla y el lenguaje, junto con la anatomía apta para hablar.' },
    ru: { question: 'Неандертальцы обладали каким геном, связанным у современных людей с языком?', options: ['BRCA1','FOXP2','HAR1','MYH16'], explanation: 'Неандертальцы несли ген FOXP2, связанный с речью и языком, наряду с анатомией, пригодной для речи.' },
    mk: { question: 'Неандерталците поседувале кој ген, поврзан кај модерните луѓе со јазикот?', options: ['BRCA1','FOXP2','HAR1','MYH16'], explanation: 'Неандерталците го носеле генот FOXP2, поврзан со говорот и јазикот, заедно со анатомијата погодна за говор.' },
  },
  'preq29': {
    es: { question: 'Los denisovanos se identificaron por primera vez en 2010 a partir de un hueso de dedo hallado en una cueva ¿de dónde?', options: ['la región de Altái en Siberia','los montes Zagros','el Levante','la isla de Flores'], explanation: 'Un solo hueso de dedo de la cueva de Denisova, en Siberia, dio el ADN de una población humana antes desconocida.' },
    ru: { question: 'Денисовцы впервые были опознаны в 2010 году по фаланге пальца, найденной в пещере где?', options: ['Алтайский регион Сибири','Горы Загрос','Левант','Остров Флорес'], explanation: 'Единственная фаланга из Денисовой пещеры в Сибири дала ДНК прежде неизвестной человеческой популяции.' },
    mk: { question: 'Денисовците првпат биле идентификувани во 2010 година од коска од прст пронајдена во пештера каде?', options: ['Регионот Алтај во Сибир','Планините Загрос','Левант','Островот Флорес'], explanation: 'Една единствена коска од прст од пештерата Денисова во Сибир дала ДНК на дотогаш непозната човечка популација.' },
  },
  'preq30': {
    es: { question: 'El diminuto humano "hobbit" que vivió en una isla de Indonesia era...', options: ['Homo naledi','Homo floresiensis','Homo heidelbergensis','Homo antecessor'], explanation: 'Homo floresiensis, apodado el "hobbit", compartió el mundo reciente con neandertales, denisovanos y nuestra propia especie.' },
    ru: { question: 'Крохотный «хоббит»-человек, живший на индонезийском острове, был...', options: ['Homo naledi','Homo floresiensis','Homo heidelbergensis','Homo antecessor'], explanation: 'Homo floresiensis, прозванный «хоббитом», делил недавний мир с неандертальцами, денисовцами и нашим видом.' },
    mk: { question: 'Ситниот „хобит“ човек што живеел на индонезиски остров бил...', options: ['Homo naledi','Homo floresiensis','Homo heidelbergensis','Homo antecessor'], explanation: 'Homo floresiensis, наречен „хобит“, го делел неодамнешниот свет со неандерталците, денисовците и нашиот вид.' },
  },
  'preq31': {
    es: { question: 'Una variante génica heredada de los denisovanos ayuda hoy ¿a qué pueblo a prosperar en la altura?', options: ['Los inuit','Los tibetanos','Los quechua andinos','Los san'], explanation: 'Una variante denisovana ayuda a los tibetanos modernos a hacer frente al aire enrarecido de la gran altitud.' },
    ru: { question: 'Генный вариант, унаследованный от денисовцев, помогает сегодня какому народу благоденствовать на высоте?', options: ['Инуиты','Тибетцы','Андские кечуа','Народ сан'], explanation: 'Денисовский вариант помогает современным тибетцам справляться с разреженным воздухом больших высот.' },
    mk: { question: 'Генска варијанта наследена од денисовците им помага денес на кој народ да напредува на голема височина?', options: ['Инуитите','Тибетанците','Андските Кечуа','Народот Сан'], explanation: 'Денисовска варијанта им помага на модерните Тибетанци да се справат со разредениот воздух на голема надморска височина.' },
  },
  'preq32': {
    es: { question: 'Los fósiles más antiguos que se parecen a Homo sapiens (~300.000 años) proceden ¿de qué sitio?', options: ['Garganta de Olduvai, Tanzania','Jebel Irhoud, Marruecos','Sterkfontein, Sudáfrica','Omo, Etiopía'], explanation: 'Jebel Irhoud, en Marruecos, retrasó el nacimiento de nuestra especie a ~300.000 años y a lo largo de todo el continente.' },
    ru: { question: 'Древнейшие ископаемые, похожие на Homo sapiens (~300 000 лет), происходят из какого места?', options: ['Олдувайское ущелье, Танзания','Джебель-Ирхуд, Марокко','Стеркфонтейн, ЮАР','Омо, Эфиопия'], explanation: 'Джебель-Ирхуд в Марокко отодвинул рождение нашего вида к ~300 000 лет и по всему материку.' },
    mk: { question: 'Најстарите фосили што личат на Homo sapiens (~300.000 години) потекнуваат од кое место?', options: ['Клисурата Олдуваи, Танзанија','Џебел Ирхуд, Мароко','Стеркфонтејн, Јужна Африка','Омо, Етиопија'], explanation: 'Џебел Ирхуд во Мароко го турна раѓањето на нашиот вид кон ~300.000 години и низ целиот континент.' },
  },
  'preq33': {
    es: { question: '¿Por qué los pueblos de fuera de África portan menos diversidad genética que los africanos?', options: ['Evolucionaron más despacio','Descienden de una pequeña población fundadora — un "cuello de botella"','Se mestizaron menos','El clima de África aumentó la mutación'], explanation: 'Casi todos los que viven fuera de África descienden de un grupo comparativamente pequeño que salió hace ~60.000–70.000 años.' },
    ru: { question: 'Почему народы вне Африки несут меньше генетического разнообразия, чем африканцы?', options: ['Они эволюционировали медленнее','Они происходят от малой основательской популяции — «бутылочного горлышка»','Они меньше скрещивались','Климат Африки усилил мутацию'], explanation: 'Почти все живущие вне Африки происходят от сравнительно небольшой группы, покинувшей Африку ~60 000–70 000 лет назад.' },
    mk: { question: 'Зошто народите надвор од Африка носат помала генетска разновидност од Африканците?', options: ['Еволуирале побавно','Потекнуваат од мала основачка популација — „грло на шише“','Помалку се вкрстувале','Климата на Африка ја зголемила мутацијата'], explanation: 'Речиси сите што живеат надвор од Африка потекнуваат од сразмерно мала група што ја напуштила Африка пред ~60.000–70.000 години.' },
  },
  'preq34': {
    es: { question: 'El gigantesco marsupial parecido a un wómbat que se esfumó tras llegar los humanos a Australia fue el...', options: ['Megalania','Diprotodon','Tilacino','Gliptodonte'], explanation: 'El Diprotodon de dos toneladas estuvo entre los marsupiales gigantes de Australia que desaparecieron poco después de llegar la gente.' },
    ru: { question: 'Гигантский, похожий на вомбата сумчатый, исчезнувший после прихода людей в Австралию, был...', options: ['Мегалания','Дипротодон','Тилацин','Глиптодон'], explanation: 'Двухтонный дипротодон был среди гигантских сумчатых Австралии, исчезнувших вскоре после прихода людей.' },
    mk: { question: 'Џиновскиот, вомбату сличен торбар што исчезнал по доаѓањето на луѓето во Австралија бил...', options: ['Мегаланија','Дипротодон','Тилацин','Глиптодон'], explanation: 'Двотонскиот Diprotodon бил меѓу џиновските торбари на Австралија што исчезнале набргу по доаѓањето на луѓето.' },
  },
  'preq35': {
    es: { question: 'La gente entró por primera vez en las Américas cruzando ¿qué puente de tierra expuesto de la glaciación?', options: ['Doggerland','Sundaland','Beringia','Sahul'], explanation: 'Beringia, una ancha pradera donde hoy está el estrecho de Bering, unía Siberia con Alaska durante la glaciación.' },
    ru: { question: 'Люди впервые вошли в Америки, перейдя по какому обнажившемуся перешейку ледникового периода?', options: ['Доггерленд','Сундаленд','Берингия','Сахул'], explanation: 'Берингия, широкая травянистая равнина там, где ныне Берингов пролив, соединяла Сибирь с Аляской в ледниковый период.' },
    mk: { question: 'Луѓето првпат влегле во Америките преминувајќи го кој откриен копнен мост од глацијацијата?', options: ['Догерленд','Сундаленд','Берингија','Сахул'], explanation: 'Берингија, широка тревна рамнина каде што денес е Беринговиот теснец, ги спојувала Сибир и Алјаска за време на глацијацијата.' },
  },
  'preq36': {
    es: { question: '¿Qué dos piedras se fracturan de un modo predecible y vítreo, ideal para tallar herramientas afiladas?', options: ['Granito y mármol','Sílex y obsidiana','Arenisca y pizarra','Basalto y cuarcita'], explanation: 'El sílex y la obsidiana se fracturan de forma concoidal, de modo que un golpe bien dirigido desprende una lasca afilada.' },
    ru: { question: 'Какие два камня раскалываются предсказуемо, по-стеклянному, идеально для изготовления острых орудий?', options: ['Гранит и мрамор','Кремень и обсидиан','Песчаник и сланец','Базальт и кварцит'], explanation: 'Кремень и обсидиан раскалываются раковисто, так что точный удар отделяет острый отщеп.' },
    mk: { question: 'Кои два камена се кршат на предвидлив, стаклест начин, идеален за изработка на остри алатки?', options: ['Гранит и мермер','Кремен и опсидијан','Песочник и шкрилец','Базалт и кварцит'], explanation: 'Кременот и опсидијанот се кршат конхоидно, така што добро насочен удар откршува остар отсечок.' },
  },
  'preq37': {
    es: { question: 'La técnica de fabricación de herramientas de "núcleo preparado" se extendió por el Viejo Mundo ¿hacia cuándo?', options: ['Hace 2,6 millones de años','Hace 1,7 millones de años','Hace 300.000 años','Hace 12.000 años'], explanation: 'Hacia hace unos 300.000 años, los talladores daban forma a un núcleo para que un golpe desprendiera una lasca de tamaño predeterminado.' },
    ru: { question: 'Техника изготовления орудий «подготовленного нуклеуса» распространилась по Старому Свету примерно когда?', options: ['2,6 млн лет назад','1,7 млн лет назад','300 000 лет назад','12 000 лет назад'], explanation: 'Около 300 000 лет назад мастера формировали нуклеус так, чтобы один удар отделял отщеп заранее заданного размера.' },
    mk: { question: 'Техниката за изработка на алат со „подготвено јадро“ се раширила низ Стариот Свет околу кога?', options: ['Пред 2,6 милиони години','Пред 1,7 милиони години','Пред 300.000 години','Пред 12.000 години'], explanation: 'Пред околу 300.000 години, изработувачите обликувале јадро така што еден удар откршувал отсечок со однапред определена големина.' },
  },
  'preq38': {
    es: { question: 'La invención de agujas con ojo en el Paleolítico Superior permitió a la gente...', options: ['Pescar con redes','Coser ropa entallada','Tejer cestas','Perforar la piedra'], explanation: 'Las agujas de hueso con ojo permitieron a los pueblos glaciales coser ropa entallada, crucial para sobrevivir al frío.' },
    ru: { question: 'Изобретение игл с ушком в верхнем палеолите позволило людям...', options: ['Ловить рыбу сетями','Шить подогнанную одежду','Плести корзины','Сверлить камень'], explanation: 'Костяные иглы с ушком позволили людям ледникового периода шить подогнанную одежду, важную для выживания в холоде.' },
    mk: { question: 'Изумот на игли со уши во Горниот Палеолит им овозможил на луѓето...', options: ['Да ловат риба со мрежи','Да шијат кроена облека','Да плетат кошници','Да дупчат камен'], explanation: 'Коскените игли со уши им овозможиле на ледничките луѓе да шијат кроена облека, клучна за преживување во студот.' },
  },
  'preq39': {
    es: { question: '¿Hacia qué momento entró en uso extendido el arco y la flecha?', options: ['Hace 2 millones de años','El final de la glaciación','La Edad del Bronce','La era romana'], explanation: 'El arco — que permitía a un cazador matar en silencio desde lejos — se usaba ampliamente para el final de la glaciación.' },
    ru: { question: 'К какому времени лук и стрелы вошли в широкое употребление?', options: ['2 млн лет назад','Конец ледникового периода','Бронзовый век','Римская эпоха'], explanation: 'Лук — позволявший охотнику убивать бесшумно издалека — широко применялся к концу ледникового периода.' },
    mk: { question: 'До кој момент лакот и стрелата влегле во широка употреба?', options: ['Пред 2 милиони години','Крајот на глацијацијата','Бронзеното Доба','Римската ера'], explanation: 'Лакот — што му овозможувал на ловецот да убива тивко оддалеку — бил во широка употреба до крајот на глацијацијата.' },
  },
  'preq40': {
    es: { question: 'El arte figurativo más antiguo conocido, un jabalí verrugoso de ~45.500 años, se halló ¿en dónde?', options: ['Francia','España','Indonesia','Sudáfrica'], explanation: 'Una pintura de jabalí verrugoso en la isla de Célebes (Sulawesi), Indonesia, es la obra de arte figurativo más antigua conocida.' },
    ru: { question: 'Древнейшее известное фигуративное искусство — бородавчатая свинья возрастом ~45 500 лет — найдено где?', options: ['Франция','Испания','Индонезия','ЮАР'], explanation: 'Роспись бородавчатой свиньи на острове Сулавеси в Индонезии — древнейшее известное фигуративное произведение.' },
    mk: { question: 'Најстарата позната фигуративна уметност, брадавичесто прасе старо ~45.500 години, е пронајдена каде?', options: ['Франција','Шпанија','Индонезија','Јужна Африка'], explanation: 'Слика на брадавичесто прасе на островот Сулавеси во Индонезија е најстарото познато фигуративно уметничко дело.' },
  },
  'preq41': {
    es: { question: 'El Hombre León de Hohlenstein-Stadel, de 40.000 años, se considera quizá el objeto más importante de la prehistoria porque...', options: ['Es la escultura humana más antigua','Representa un ser que no existe en la naturaleza — prueba de imaginación','Se talló en oro macizo','Muestra los primeros símbolos escritos'], explanation: 'Un humano de cabeza de león tallado en marfil de mamut representa algo nunca visto — la esencia de la mente que imagina.' },
    ru: { question: 'Человек-лев из Холенштайн-Штаделя (40 000 лет) считается, пожалуй, важнейшим предметом доистории, потому что...', options: ['Это древнейшая человеческая скульптура','Он изображает существо, которого нет в природе, — доказательство воображения','Он вырезан из чистого золота','Он показывает первые письменные символы'], explanation: 'Человек с головой льва, вырезанный из мамонтовой кости, изображает никогда не виданное — суть воображающего ума.' },
    mk: { question: 'Човекот-Лав од Холенштајн-Штадел, стар 40.000 години, се смета за можеби најважниот предмет во праисторијата зашто...', options: ['Е најстарата човечка скулптура','Прикажува суштество што не постои во природата — доказ за имагинација','Е изрежан од чисто злато','Ги покажува првите пишани симболи'], explanation: 'Човек со глава на лав изрежан од мамутска слонова коска прикажува нешто никогаш видено — суштината на умот што замислува.' },
  },
  'preq42': {
    es: { question: 'La famosa figura Venus de Willendorf se talló ¿hace aproximadamente cuánto tiempo?', options: ['~10.000 años','~25.000 años','~45.000 años','~5.000 años'], explanation: 'La Venus de Willendorf, tallada hace unos 25.000 años, es una de las muchas "figuras de Venus" glaciales similares.' },
    ru: { question: 'Знаменитая фигурка Венера из Виллендорфа была вырезана примерно как давно?', options: ['~10 000 лет','~25 000 лет','~45 000 лет','~5 000 лет'], explanation: 'Венера из Виллендорфа, вырезанная около 25 000 лет назад, — одна из многих схожих ледниковых «фигурок Венеры».' },
    mk: { question: 'Славната фигурка Венера од Вилендорф била изрежана пред приближно колку време?', options: ['~10.000 години','~25.000 години','~45.000 години','~5.000 години'], explanation: 'Венера од Вилендорф, изрежана пред околу 25.000 години, е една од многуте слични леднички „фигурки на Венера“.' },
  },
  'preq43': {
    es: { question: 'En el último máximo glacial (~20.000 años), tanta agua quedó atrapada en el hielo que el nivel del mar global descendió más de...', options: ['10 metros','40 metros','100 metros','300 metros'], explanation: 'El nivel del mar bajó más de cien metros, dejando al descubierto puentes de tierra como Beringia y llanuras costeras ahogadas.' },
    ru: { question: 'В последний ледниковый максимум (~20 000 лет) столько воды было заперто во льду, что глобальный уровень моря упал более чем на...', options: ['10 метров','40 метров','100 метров','300 метров'], explanation: 'Уровень моря упал более чем на сто метров, обнажив перешейки вроде Берингии и утопленные прибрежные равнины.' },
    mk: { question: 'Во последниот леднички максимум (~20.000 години), толку многу вода била заклучена во мразот што глобалното морско ниво паднало повеќе од...', options: ['10 метри','40 метри','100 метри','300 метри'], explanation: 'Морското ниво паднало повеќе од сто метри, откривајќи копнени мостови како Берингија и удавени крајбрежни рамнини.' },
  },
  'preq44': {
    es: { question: 'La vasta pradera fría y seca que iba de España a través de Eurasia hasta el Yukón durante la glaciación se llama...', options: ['taiga','estepa del mamut','cinturón de tundra','llanura de Sahul'], explanation: 'La estepa del mamut rebosaba de mamuts, rinocerontes lanudos, caballos, bisontes y renos.' },
    ru: { question: 'Обширная холодная сухая травянистая равнина, тянувшаяся от Испании через Евразию до Юкона в ледниковый период, называется...', options: ['тайга','мамонтовая степь','тундровый пояс','равнина Сахул'], explanation: 'Мамонтовая степь кишела мамонтами, шерстистыми носорогами, лошадьми, бизонами и северными оленями.' },
    mk: { question: 'Пространата студена сува тревна рамнина што одела од Шпанија низ Евроазија до Јукон за време на глацијацијата се вика...', options: ['тајга','мамутска степа','тундрен појас','рамнина Сахул'], explanation: 'Мамутската степа врела од мамути, волнести носорози, коњи, бизони и ирваси.' },
  },
  'preq45': {
    es: { question: 'Las extinciones de megafauna glacial fueron más leves en África. ¿La mejor explicación es que los animales africanos...?', options: ['Eran demasiado grandes para cazar','Habían coevolucionado con homínidos durante millones de años','Vivían donde el clima nunca cambió','Estaban protegidos por leyes tempranas'], explanation: 'Al haber evolucionado junto a homínidos durante eras, la megafauna africana era más cautelosa con los humanos; las extinciones golpearon más donde los animales conocieron a la gente por primera vez.' },
    ru: { question: 'Вымирания ледниковой мегафауны были мягче всего в Африке. Лучшее объяснение — что африканские животные...?', options: ['Были слишком велики для охоты','Сомиллионнолетно эволюционировали с гомининами','Жили там, где климат не менялся','Были защищены ранними законами'], explanation: 'Эволюционировав рядом с гомининами эпохами, африканская мегафауна была осторожнее с людьми; вымирания сильнее ударили там, где животные впервые встретили людей.' },
    mk: { question: 'Изумирањата на ледничката мегафауна биле најблаги во Африка. Најдоброто објаснување е дека африканските животни...?', options: ['Биле премногу големи за ловење','Коеволуирале со хоминини милиони години','Живееле каде што климата никогаш не се менувала','Биле заштитени со рани закони'], explanation: 'Еволуирајќи покрај хоминините низ ери, африканската мегафауна била повнимателна кон луѓето; изумирањата удриле најтешко каде што животните ги сретнале луѓето за првпат.' },
  },
  'preq46': {
    es: { question: 'La época geológica cálida y estable que comenzó hace ~11.700 años y en la que aún vivimos es el...', options: ['Pleistoceno','Holoceno','Plioceno','Mioceno'], explanation: 'El clima cálido y estable del Holoceno preparó el escenario para la invención de la agricultura.' },
    ru: { question: 'Тёплая устойчивая геологическая эпоха, начавшаяся ~11 700 лет назад, в которой мы всё ещё живём, — это...', options: ['Плейстоцен','Голоцен','Плиоцен','Миоцен'], explanation: 'Тёплый устойчивый климат голоцена подготовил сцену для изобретения земледелия.' },
    mk: { question: 'Топлата, стабилна геолошка епоха што започнала пред ~11.700 години и во која сè уште живееме е...', options: ['Плеистоцен','Холоцен','Плиоцен','Миоцен'], explanation: 'Топлата, стабилна клима на холоценот ја подготвила сцената за изумот на земјоделството.' },
  },
  'preq47': {
    es: { question: 'Algunos estudiosos llaman a la agricultura "el peor error de la historia de la raza humana" porque los primeros agricultores eran a menudo...', options: ['Exterminados por sus vecinos','Más bajos, más enfermizos y más desgastados que los recolectores','Incapaces de almacenar comida','Obligados a abandonar el fuego'], explanation: 'Una dieta estrechada a unos pocos cultivos traía carencias, dientes cariados, nuevas enfermedades de hacinamiento y riesgo de hambruna — pero la agricultura venció igual al alimentar a más gente.' },
    ru: { question: 'Иные учёные называют земледелие «худшей ошибкой в истории человеческого рода», потому что первые земледельцы часто были...', options: ['Истреблены соседями','Ниже ростом, болезненнее и изношеннее собирателей','Неспособны хранить пищу','Вынуждены отказаться от огня'], explanation: 'Рацион, суженный до немногих культур, нёс недостаточность, гнилые зубы, новые болезни скученности и риск голода — но земледелие всё же победило, прокормив больше людей.' },
    mk: { question: 'Некои научници го нарекуваат земјоделството „најлошата грешка во историјата на човечкиот род“ зашто првите земјоделци честопати биле...', options: ['Истребени од соседите','Пониски, поболникави и поизнурени од собирачите','Неспособни да складираат храна','Принудени да го напуштат огнот'], explanation: 'Исхрана стеснета на неколку посеви носела недостатоци, скапани заби, нови болести од збиеност и ризик од глад — но земјоделството сепак победило хранејќи повеќе луѓе.' },
  },
  'preq48': {
    es: { question: 'En las tierras altas de México, el maíz se domesticó a partir de ¿qué escuálida gramínea silvestre?', options: ['Emmer','Teosinte','Sorgo','Escaña'], explanation: 'El maíz se crió a lo largo de generaciones a partir del teosinte, junto con frijoles y calabazas — una de las invenciones independientes de la agricultura.' },
    ru: { question: 'В нагорьях Мексики кукурузу одомашнили из какого чахлого дикого злака?', options: ['Эммер','Теосинте','Сорго','Однозернянка'], explanation: 'Кукурузу выводили поколениями из теосинте, наряду с бобами и тыквой, — одно из независимых изобретений земледелия.' },
    mk: { question: 'Во високите предели на Мексико, пченкарот бил припитомен од која грмушеста дива трева?', options: ['Емер','Теосинте','Сорго','Едножитна пченица'], explanation: 'Пченкарот бил одгледуван низ генерации од теосинте, заедно со грав и тиква — еден од независните изуми на земјоделството.' },
  },
  'preq49': {
    es: { question: 'La protociudad de Çatalhöyük era llamativamente inusual porque sus casas...', options: ['Estaban hechas de bloques de piedra','No tenían calles ni puertas a nivel del suelo y se entraban por el techo','Rodeaban un palacio central','Se alzaban sobre pilotes de madera'], explanation: 'Sus casas de adobe estaban apretadas pared con pared; la gente caminaba por los tejados y bajaba por escaleras a sus hogares.' },
    ru: { question: 'Протогород Чатал-Хёюк был поразительно необычен тем, что его дома...', options: ['Были из каменных блоков','Не имели улиц и дверей на уровне земли и входились через крышу','Окружали центральный дворец','Стояли на деревянных сваях'], explanation: 'Его глинобитные дома были стиснуты стена к стене; люди ходили по крышам и спускались по лестницам в жилища.' },
    mk: { question: 'Протоградот Чаталхујук бил впечатливо необичен зашто неговите куќи...', options: ['Биле направени од камени блокови','Немале улици ниту врати на ниво на земјата и се влегувало преку кровот','Опкружувале централна палата','Стоеле на дрвени столбови'], explanation: 'Неговите куќи од кал биле збиени ѕид до ѕид; луѓето оделе по крововите и се симнувале по скали во домовите.' },
  },
  'preq50': {
    es: { question: 'Hacia el 3300 a.C., la gente hizo el primer bronce verdadero aleando cobre con...', options: ['Hierro','Plomo','Estaño','Plata'], explanation: 'El cobre aleado con estaño da el bronce — lo bastante duro para herramientas y armas serias, cerrando la Edad de Piedra.' },
    ru: { question: 'Около 3300 года до н.э. люди сделали первую настоящую бронзу, сплавив медь с...', options: ['Железом','Свинцом','Оловом','Серебром'], explanation: 'Медь, сплавленная с оловом, даёт бронзу — достаточно твёрдую для серьёзных орудий и оружия, закрывшую каменный век.' },
    mk: { question: 'Околу 3300 п.н.е., луѓето ја направиле првата вистинска бронза легирајќи бакар со...', options: ['Железо','Олово','Калај','Сребро'], explanation: 'Бакарот легиран со калај дава бронза — доволно тврда за сериозни алатки и оружја, затворајќи го Каменото Доба.' },
  },
};
