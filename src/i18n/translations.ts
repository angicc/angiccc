...
const EN: TranslationKeys = {
    ...
    guide_free_pro: 'Free & Pro plans', guide_qs_desc: 'New here? Start by completing a lesson in the Eras & Lessons section, then take the era quiz to earn XP. Once you have a feel for the app, upgrade to Pro to unlock all 134 lessons and the AI Tutor.',
    // Report
...
export const T: Translations = {
  ...
  es: {
    ...
    guide_free_pro: 'Planes Gratuito y Pro', guide_qs_desc: '¿Eres nuevo? Comienza completando una lección en la sección Eras y Lecciones, luego haz el quiz de era para ganar XP. Una vez que conozcas la app, actualiza a Pro para desbloquear todas las 134 lecciones y el Tutor IA.',
  ...
  ru: {
    ...
    guide_free_pro: 'Бесплатный и Pro', guide_qs_desc: 'Впервые здесь? Начните с урока в разделе «Эпохи и Уроки», затем пройдите викторину по эпохе, чтобы получить XP. Освоившись с приложением, обновитесь до Pro для доступа ко всем 134 урокам и Наставнику.',
  ...
  mk: {
    ...
    guide_free_pro: 'Бесплатен и Pro план', guide_qs_desc: 'Нов/а си? Почни со завршување на лекција во делот Епохи и Лекции, потоа направи квиз за да освоиш XP. Откако ќе се запознаеш со апликацијата, надгради на Pro за да ги отклучиш сите 134 лекции и ВИ Туторот.',
