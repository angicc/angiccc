...
import {
  isAnalysisPassed, startCooldown, endCooldown, getLessonLock, useCooldownRemaining, formatCooldown,
...
export default function LessonPage() {
  ...
  function handleAnalysisPassed(v: import('@/features/progress/analysisGrader').AnalysisVerdict) {
    ...
    // Passing the analysis ends the 30-minute reflection cooldown early, so the
    // next lesson opens immediately instead of waiting out the timer.
    endCooldown(currentUser.id);
