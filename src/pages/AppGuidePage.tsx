...
const STEPS = [
  ...
  },
  {
    ...
    tips: ['Each era has 6–7 lessons', 'Lessons include rich historical detail', 'Complete a lesson to unlock the era quiz'],
    link: '/eras',
  ...
  },
  {
    ...
    desc: 'A new philosopher is featured every 12 hours. Engage them in vigorous philosophical debate — they have pre-loaded arguments and a strong command of their own philosophy. Make them concede to earn XP.',
    tips: ['Available on Pro Learner and above', 'A new philosopher appears every 12 hours', 'Earn XP by making the philosopher concede', 'Greater philosophers yield more XP', 'Use pre-loaded starter arguments or write your own'],
    link: '/debate',
