...
import { BookOpen, Brain, ScrollText, Sparkles, Layers, BarChart2, PenLine, Crown, ArrowRight, CheckCircle2, Trophy, Flame, User, FileEdit, Film, Scale, Globe2, Hourglass, Route, Wand2 } from 'lucide-react';
